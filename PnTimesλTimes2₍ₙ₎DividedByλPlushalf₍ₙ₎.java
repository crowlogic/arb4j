...
public class PnTimesλTimes2₍ₙ₎DividedByλPlushalf₍ₙ₎ implements Function<Integer, RealPolynomial> {
   ...
   public RealPolynomial evaluate(Integer in, int order, int bits, RealPolynomial result) {
      ...
      return (P.evaluate(in, order, bits, r̅1))
   ...
   public PnTimesλTimes2_ₙ_DividedByλPlushalf_ₙ_/* $VF was: PnTimesλTimes2₍ₙ₎DividedByλPlushalf₍ₙ₎*/() {
      c1 = new Integer("2");
