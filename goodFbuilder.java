package asm.arb.functions.real;
...
classWriter.visit(-65471, ACC_PUBLIC | ACC_SUPER, "arb/functions/real/F", "Ljava/lang/Object;Larb/functions/Function<Larb/Integer;Larb/RealPolynomial;>;", "java/lang/Object", new String[] { "arb/functions/Function" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL, "factor\u211d2", "Larb/functions/real/factor\u211d2;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL, "factor\u211d1", "Larb/functions/real/factor\u211d1;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"[Ljava/lang/String;", "java/lang/Throwable", "java/lang/Throwable", "arb/functions/real/F", "java/lang/Throwable", "java/lang/Throwable", "arb/Integer", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/functions/real/F", "evaluate", "(Larb/Integer;IILarb/RealPolynomial;)Larb/RealPolynomial;", false);
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintStream", "format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintStream;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"[Ljava/lang/String;", "java/lang/Throwable", "java/lang/Throwable", "arb/functions/real/F", "java/lang/Throwable", "java/lang/Throwable", "arb/Integer"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "evaluate", "(Larb/Integer;IILarb/RealPolynomial;)Larb/RealPolynomial;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
methodVisitor.visitLabel(label0);
...
Label label3 = new Label();
Label label4 = new Label();
methodVisitor.visitTableSwitchInsn(0, 0, label4, new Label[] { label3 });
methodVisitor.visitLabel(label3);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/RealPolynomial", "set", "(Larb/Integer;)Larb/RealPolynomial;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
Label label5 = new Label();
methodVisitor.visitLabel(label5);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/Integer", "sub", "(Larb/Integer;ILarb/Integer;)Larb/Integer;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/RealPolynomial", "mul", "(Larb/RealPolynomial;ILarb/RealPolynomial;)Larb/RealPolynomial;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitLineNumber(78, label7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "arb/functions/real/F", "factor\u211d1", "Larb/functions/real/factor\u211d1;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"arb/RealPolynomial"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "arb/functions/real/F", "product\u211d1", "Larb/Real;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "arb/functions/real/F", "factor\u211d1", "Larb/functions/real/factor\u211d1;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/functions/real/factor\u211d1", "evaluate", "(Ljava/lang/Object;ILjava/lang/Object;)Ljava/lang/Object;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/RealPolynomial", "mul", "(Larb/Real;ILarb/RealPolynomial;)Larb/RealPolynomial;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
Label label15 = new Label();
methodVisitor.visitLabel(label15);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/Integer", "factorial", "(ILarb/Integer;)Larb/Integer;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
Label label16 = new Label();
methodVisitor.visitLabel(label16);
methodVisitor.visitLineNumber(91, label16);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "arb/functions/real/F", "factor\u211d2", "Larb/functions/real/factor\u211d2;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"arb/Integer"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "arb/functions/real/F", "product\u211d2", "Larb/Real;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "arb/functions/real/F", "factor\u211d2", "Larb/functions/real/factor\u211d2;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/functions/real/factor\u211d2", "evaluate", "(Ljava/lang/Object;ILjava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "arb/Real");
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/Real", "mul", "(Larb/Real;I)Larb/Real;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "arb/RealPolynomial", "div", "(Larb/Real;ILarb/RealPolynomial;)Larb/RealPolynomial;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label6);
...
methodVisitor.visitFieldInsn(PUTFIELD, "arb/functions/real/F", "factor\u211d2", "Larb/functions/real/factor\u211d2;");
Label label2 = new Label();
methodVisitor.visitLabel(label2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "arb/functions/real/F", "factor\u211d1", "Larb/functions/real/factor\u211d1;");
Label label3 = new Label();
methodVisitor.visitLabel(label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_BRIDGE | ACC_SYNTHETIC, "evaluate", "(Ljava/lang/Object;IILjava/lang/Object;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
methodVisitor.visitLabel(label0);
