      ...
      if (this.α == null) {
         ...
         return switch(in.getSignedValue()) {
            ...
            default -> {
               ...
               var5 = var5.mul((RealPolynomial)this.P.evaluate(in.sub(this.const2, bits, this.ℤ1), order, bits, this.𝕽5), bits, this.𝕽6);
               ...
               yield var5.sub(
                     var10001.mul((RealPolynomial)this.P.evaluate(in.sub(this.const3, bits, this.ℤ2), order, bits, this.𝕽7), bits, this.𝕽8), bits, this.𝕽9
                  )
