...
\begin{proof}
  \begin{enumerate}
    ...
    \begin{equation}
      \label{eqfirstpartial} \frac{\partial}{\partial s} K_Z (s, t) =
      \frac{\ddot{\theta} (s)}{2 \sqrt{\dot{\theta} (s) \dot{\theta} (t)}} 
      \hspace{0.17em} K (\theta (t) - \theta (s)) - \dot{\theta} (s)
      \sqrt{\dot{\theta} (s) \dot{\theta} (t)}  \hspace{0.17em} \dot{K} 
      (\theta (t) - \theta (s))
    \end{equation}
