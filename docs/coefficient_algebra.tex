...
\begin{abstract}
  ...
  prices under explicit hypotheses on a fixed contour with no
...
\begin{definition}
  [Contour pricing functional]\label{def:contour} Fix maturity $T > 0$,
  ...
  {\tmem{(Carr--Madan {\cite{CarrMadan}}; Gil-Pelaez
  {\cite{GilPelaez}})}}.
\end{definition}
...
\begin{proof}
  ...
  kernel of Definition~\ref{def:contour} there).
\end{proof}
