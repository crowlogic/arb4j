...
<\body>
  <doc-data|<doc-title|<strong|A Pair of Orthogonal Polynomial Sequences on
  <math|<around*|[|0,\<infty\>|]>> That Uniformly \ Converge to The Bessel
  functions of the First Kind of Orders <math|0> and 1>
  ...
  <\table-of-contents|toc>
    ...
    Integral Covariance Operator> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
  ...
  <\equation>
    <tabular|<tformat|<table|<row|<cell|\<lambda\><rsub|k>>|<cell|=<sqrt|<frac|4k+1|\<pi\>>><around*|(|k+1|)><rsub|-<frac|1|2>><rsup|2>>>|<row|<cell|>|<cell|=<sqrt|<frac|4k+1|\<pi\>>><frac|\<Gamma\><around*|(|k+<frac|1|2>|)><rsup|2>|\<Gamma\><around*|(|k+1|)><rsup|2>>>>>>>
  </equation>

  which, together with the eigenfunctions

  <\equation>
    \<psi\><rsub|k><around*|(|x|)>=e<rsup|i\<pi\>k><sqrt|<frac|4k+1|\<pi\>>>j<rsub|2k><around*|(|y|)>
  </equation>

  \ solve the characteristic(eigenfunction) equation

  <\equation>
    \<psi\><rsub|k><around*|(|y|)>=\<lambda\><rsub|k><big|int><rsub|0><rsup|\<infty\>>J<rsub|0><around*|(|x-y|)>\<psi\><rsub|k><around*|(|x|)>\<mathd\>x
  </equation>

  so that

  <\equation*>
    J<rsub|0><around*|(|x|)>=<big|sum><rsub|k=0><rsup|\<infty\>>\<lambda\><rsub|k>\<psi\><rsub|k><around*|(|y|)>
  </equation*>
</body>
