...
<\body>
  ...
  <\table-of-contents|toc>
    ...
    <with|par-left|1tab|1.1<space|2spc>The Riemann <with|color|dark
    red|font-family|rm|<with|mode|math|\<zeta\>>> And Related Function
    <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-2>>

    <with|par-left|2tab|1.1.1<space|2spc>Roots of <with|color|dark
    red|font-family|rm|<with|mode|math|X<around*|(|t|)>>>
    <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-5>>

    <with|par-left|1tab|1.2<space|2spc>The Schröder Equation
    <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-6>>

    <with|par-left|2tab|1.2.1<space|2spc>Koenig's Linearization Theorem
    <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-7>>

    <with|par-left|1tab|1.3<space|2spc>Eigenfunctions of Compact Composition
    Operators <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-9>>

    <with|par-left|2tab|1.3.1<space|2spc>The Frobenius-Perron Transfer
    Operator <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-10>>

    <with|par-left|2tab|1.3.2<space|2spc>Spectra of the Newton Map of the S
  ...
  unnatural appearance), to its eventual elevation to the status of a
  ...
  recur in this instance where the concept is a function whose effect when
  composed with another function is to provide a way to linearize the Newton
  flow in the vicinity of super-attractive and indifferent fixed-points by
  transforming them to geometrically-attracting fixed-points and thus
  rendering them linearizable via Koenig's theorem of iteratively renormaized
  function composition and also proving that the roots of the <math|\<zeta\>>
  function are indeed simple due to the \Pmultiplicity one\Q lemma of
  Koenig's eigenfunctions , thus proving the crucial fact needed to transform
  the problem back into the domain of the lines-of-constant-phase
  ...
  is a rational meromorphic quartic function which has 4 poles at
  ...
  <subsubsection|Roots of <math|X<around*|(|t|)>>>

  All roots of <math|Z> are roots of <math|X> but the converse is not true
  because the <math|S<around*|(|t|)>> function has additional roots which
  become roots of the composite function and therefore
  <math|X<around*|(|t|)>> has strictly more roots than just those of the
  <math|Z<around*|(|t|)>> function.
  ...
  is, if <math|\<rho\>=x+i y> is a root <math|X<around*|(|\<rho\>|)>=0> then
  so is the complement which is the complex conjugate
  <math|X<around*|(|<wide|\<rho\>|\<bar\>>|)>=0> where
  <math|<wide|\<rho\>|\<bar\>>=x-i y>.

  <subsection|The Schröder Equation>

  <\definition>
    Schröder's equation is functional eigenvalue equation for the (Koopman)
  ...
  <\bibliography|bib|tm-plain|refs>
    <\bib-list|17>
      ...
      <bibitem*|11><label|bib-osserman1996poetry>R.<nbsp>Osserman.
      <newblock><with|font-shape|italic|Poetry of the Universe: A
      Mathematical Exploration of the Cosmos>. <newblock>Knopf Doubleday
      Publishing Group, 1996.<newblock>
  ...
  <\the-index|idx>
    <index+1|critical line|<pageref|auto-31>>

    <index+1|desingularized Newton flow (for entire
    functions)|<pageref|auto-25>>

    <index+1|functional derivative|<pageref|auto-20>>

    <index+1|gamma function|<pageref|auto-34>>

    <index+1|Hardy Z function|<pageref|auto-37>>

    <index+1|Koenig's function|<pageref|auto-8>>

    <index+1|Newton flow|<pageref|auto-23>>

    <index+1|Newton map|<pageref|auto-19>>

    <index+1|Riemann zeta function|<pageref|auto-29>>

    <index+1|Riemann-Siegel (var)theta function|<pageref|auto-36>>

    <index+1|transfer operator|<pageref|auto-11>>
  </the-index>
</body>
...
<\references>
  <\collection>
    ...
    <associate|auto-11|<tuple|transfer operator|3>>
    <associate|auto-12|<tuple|transfer operator|3>>
    <associate|auto-13|<tuple|1.3.2|3>>
    <associate|auto-14|<tuple|1.4|3>>
    <associate|auto-15|<tuple|2|4>>
    <associate|auto-16|<tuple|2.1|4>>
    ...
    <associate|auto-23|<tuple|Newton flow|6>>
    <associate|auto-24|<tuple|2.3.3|6>>
    <associate|auto-25|<tuple|desingularized Newton flow (for entire
    functions)|6>>
    <associate|auto-26|<tuple|2.3.4|6>>
    <associate|auto-27|<tuple|2.3.5|6>>
    <associate|auto-28|<tuple|3|7>>
    <associate|auto-29|<tuple|Riemann zeta function|7>>
    <associate|auto-3|<tuple|1|2>>
    <associate|auto-30|<tuple|3.1|7>>
    <associate|auto-31|<tuple|critical line|7>>
    <associate|auto-32|<tuple|3.1.1|7>>
    <associate|auto-33|<tuple|3.2|7>>
    <associate|auto-34|<tuple|gamma function|7>>
    <associate|auto-35|<tuple|3.2.1|7>>
    <associate|auto-36|<tuple|Riemann-Siegel (var)theta function|7>>
    <associate|auto-37|<tuple|Hardy Z function|8>>
    <associate|auto-38|<tuple|3|8>>
    <associate|auto-39|<tuple|3.3|8>>
    <associate|auto-4|<tuple|2|2>>
    <associate|auto-40|<tuple|3.3.1|8>>
    <associate|auto-41|<tuple|3.3.2|9>>
    <associate|auto-42|<tuple|4|9>>
    <associate|auto-43|<tuple|5|9>>
    <associate|auto-44|<tuple|5.1|9>>
    <associate|auto-45|<tuple|52|9>>
    <associate|auto-46|<tuple|17|10>>
    <associate|auto-5|<tuple|1.1.1|2>>
    <associate|auto-6|<tuple|1.2|2>>
    <associate|auto-7|<tuple|1.2.1|2>>
    <associate|auto-8|<tuple|Koenig's function|2>>
    ...
    <associate|bib-Shapiro1998CompositionOA|<tuple|15|10>>
    <associate|bib-constantPhaseRH|<tuple|14|10>>
    <associate|bib-cowen1994spectra|<tuple|2|9>>
    <associate|bib-coxeter1989introduction|<tuple|3|9>>
    <associate|bib-ds2|<tuple|17|10>>
    ...
    <associate|bib-osserman1996poetry|<tuple|11|9>>
    <associate|bib-riemann|<tuple|13|10>>
    <associate|bib-shapiro1993composition|<tuple|16|10>>
...
<\auxiliary>
  <\collection>
    ...
    <\associate|idx>
      <tuple|<tuple|Koenig's function>|<pageref|auto-8>>

      <tuple|<tuple|transfer operator>|<pageref|auto-11>>

      <tuple|<tuple|transfer operator>|<pageref|auto-12>>

      <tuple|<tuple|Newton map>|<pageref|auto-19>>

      <tuple|<tuple|functional derivative>|<pageref|auto-20>>

      <tuple|<tuple|Newton flow>|<pageref|auto-23>>

      <tuple|<tuple|desingularized Newton flow (for entire
      functions)>|<pageref|auto-25>>

      <tuple|<tuple|Riemann zeta function>|<pageref|auto-29>>

      <tuple|<tuple|critical line>|<pageref|auto-31>>

      <tuple|<tuple|gamma function>|<pageref|auto-34>>

      <tuple|<tuple|Riemann-Siegel (var)theta function>|<pageref|auto-36>>

      <tuple|<tuple|Hardy Z function>|<pageref|auto-37>>
    </associate>
    <\associate|toc>
      ...
      <with|par-left|<quote|1tab>|1.1<space|2spc>The Riemann
      <with|color|<quote|dark red>|font-family|<quote|rm>|<with|mode|<quote|math>|\<zeta\>>>
      And Related Function <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-2>>

      <with|par-left|<quote|2tab>|1.1.1<space|2spc>Roots of
      ...
      <with|par-left|<quote|1tab>|1.3<space|2spc>Eigenfunctions of Compact
      ...
      <with|par-left|<quote|2tab>|1.3.1<space|2spc>The Frobenius-Perron
      Transfer Operator <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-10>>

      <with|par-left|<quote|2tab>|1.3.2<space|2spc>Spectra of the Newton Map
