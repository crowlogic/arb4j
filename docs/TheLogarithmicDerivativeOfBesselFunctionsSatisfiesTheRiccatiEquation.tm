...
<\body>
  <doc-data|<doc-title|The Logarithmic Derivative of Bessel Functions>>
  ...
  <\equation*>
    w<rprime|'><around|(|t|)>=p<around|(|t|)>+q<around|(|t|)>*w<around|(|t|)>+r<around|(|t|)>*w<around|(|t|)><rsup|2>
  </equation*>

  where:

  <\equation*>
    p<around|(|t|)>=-<around|(|1-<frac|n<rsup|2>|t<rsup|2>>|)>
  </equation*>
