...
<\body>
  ...
  <\align>
    <tformat|<table|<row|<cell|c<rsub|00><around|(|t|)>>|<cell|=0.5*K<rsub|\<Psi\>*\<Psi\>><around|(|t,t|)>=2*<big|int><rsub|0><rsup|\<infty\>>G<rsub|X*X><around|(|t,\<omega\>|)><math-up|d>\<omega\>=\<sigma\><rsub|X><rsup|2><around|(|t|)>>>|<row|<cell|c<rsub|11><around|(|t|)>>|<cell|=0.5*K<rsub|<wide|\<psi\>|\<dot\>><wide|\<psi\>|\<dot\>>><around|(|t,t|)>=2*<big|int><rsub|0><rsup|\<infty\>>G<rsub|<wide|X|\<dot\>>*<wide|X|\<dot\>>><around|(|t,\<omega\>|)><math-up|d>\<omega\>=\<sigma\><rsub|<wide|X|\<dot\>>><rsup|2><around|(|t|)>>>|<row|<cell|c<rsub|01><around|(|t|)>>|<cell|=c<rsub|10><rsup|\<ast\>><around|(|t|)>=-0.5*i*K<rsub|\<Psi\>*<wide|\<psi\>|\<dot\>>><around|(|t,t|)>=-2*i*<big|int><rsub|0><rsup|\<infty\>>G<rsub|X*<wide|X|\<dot\>>><around|(|t,\<omega\>|)><math-up|d>\<omega\><eq-number><label|eq:44>>>>>
  </align>
