...
<\body>
  ...
  <with|font-series|bold|Proposition 1.> If
  ...
  harmonizable and the <math|f> of (ii) is then the Fourier transform of some
  scalar measure <math|\<mu\>> on <math|\<bbb-R\>> (so that
  <math|f=<wide|\<mu\>|^>>).
  ...
  <with|font-series|bold|Proposition 2.> Let
  <math|<around|{|X<rsub|t>,t\<in\>\<bbb-R\>|}>> be a weakly harmonizable
  process with <math|L<rsup|2><around|(|F|)>> as its spectral domain. If
  <math|<around|{|<wide|f|~><rsub|n>,n\<geq\>1|}>> is a complete orthonormal
  set in <math|L<rsup|2><around|(|F|)>> and
  ...
  <\equation>
    X<rsub|t>=<big|sum><rsub|n=1><rsup|\<infty\>>a<rsub|n><around|(|t|)>*\<xi\><rsub|n>,<space|1em>t\<in\>\<bbb-R\>
  </equation>
  ...
  <with|font-series|bold|Proposition 3.> Let
  ...
  <with|font-series|bold|Remark:> If <math|T> is a compact set, then no
  factor such as <math|<around|[|<around|(|1+s<rsup|2>|)>*<around|(|1+t<rsup|2>|)>|]><rsup|-<frac|1|2>>>
  is needed in the above development, since the classical Mercer theorem
  applies and yields the expansion (15) for <math|r>. In the noncompact case,
  Mercer's theorem is no longer available and some such positive factor seems
  necessary to invoke the Hilbert-Schmidt result.
  ...
  <with|font-series|bold|Theorem 4.> Let <math|<around|{|X<rsub|t>,t\<in\>\<bbb-R\>|}>>
  be a process of the form (18) with <math|g=<wide|f|^>>, where
  <math|f\<in\>L<rsup|1><around|(|\<bbb-R\>|)>> and <math|Z> is a stochastic
  measure with values in <math|L<rsub|0><rsup|2><around|(|P|)>>. Then the
  process is strongly harmonizable and its spectral measure is absolutely
  continuous relative to the planar Lebesgue measure.

  <with|font-series|bold|Proof:> Since <math|g=<wide|f|^>> in (18), and hence
  <math|g> is bounded, it follows that the integral is well defined as a
  Dunford-Schwartz integral, and some of it properties will be used. Thus,
  since a form of the Fubini theorem is available here (cf. [11], p. 317 for
  ...
  is a weakly harmonizable process by ([2], Prop. 6.4), and the integral now
  becomes a Bochner integral. Let <math|<wide|Z|~>:A\<mapsto\><big|int><rsub|A><wide|Y|~><around|(|t|)>*f<around|(|t|)>*d*t,A\<in\>\<cal-B\>>.
  ...
  <with|font-series|bold|Proposition 5.> <with|font-shape|italic|The class of
  oscillatory processes <math|<around|{|X<rsub|t>,t\<in\>T|}>\<subset\>L<rsub|0><rsup|2><around|(|P|)>>
  ...
  <with|font-series|bold|Theorem 6.> <with|font-shape|italic|Let
  <math|<around|{|X<rsub|t>,t\<in\>T|}>\<subset\>L<rsub|0><rsup|2><around|(|P|)>>
  be a mean continuous process. Then it is representable as>

  <\with|font-shape|italic>
    <\equation>
      X<rsub|t>=A<rsub|t>*U<rsub|t>*Y<rsub|0>,<space|1em>t\<in\>T*<space|1em><around|(|T=\<bbb-R\>*<text|or
      >\<bbb-Z\>|)>
    </equation>
    ...
    group of operators in <math|\<cal-H\><around|(|X|)>> which commutes with
    each <math|A<rsub|t>,t\<in\>T>. If, moreover, the process is weakly
    harmonizable, then there is an enlarged Hilbert space
    <math|\<cal-K\>\<supset\>\<cal-H\><around|(|X|)>>, operators
    <math|A<rsub|t>:\<cal-K\>\<to\>\<cal-H\><around|(|X|)>> and
    <math|<around|{|U<rsub|s>,s\<in\>T|}>> a weakly continuous unitary group
    on <math|\<cal-K\>>, <math|Y<rsub|0>\<in\>\<cal-K\>>, such that
    ...
    On the other hand a process defined by (21) is always weakly harmonizable
    if only <math|<around|{|A<rsub|t>,t\<in\>T|}>> is a weakly continuous
    positive definite contractive family of operators there, with
    <math|A<rsub|0>=> identity, as above.
  </with>

  <with|font-series|bold|Proof:> This result is obtained from several known,
  but deep, facts and we include its essential details for completeness.
  ...
  and a Borel measure <math|\<mu\>>. By the preceding proposition, replacing
  <math|g<rsub|t><rprime|'>> with <math|e<rsup|i*t<around|(|\<cdummy\>|)>>*g<rsub|t>>,
  we may express this as (<math|<wide|T|^>> denoting the dual group of
  <math|T>):
  ...
  <math|\<less\>\<infty\>>. But then the <math|Y<rsub|t>>-process defined by

  <\equation>
    Y<rsub|t>=<big|int><rsub|<wide|T|^>>e<rsup|i*t*\<lambda\>>*Z*<around|(|d*\<lambda\>|)>\<forall\>t\<in\>T
  </equation>

  is stationary; so, as is well known, there is a weakly continuous group of
  unitary operators <math|<around|{|U<rsub|t>,t\<in\>T|}>> on
  <math|\<cal-H\><around|(|X|)>> such that
  <math|Y<rsub|t>=U<rsub|t>*Y<rsub|0>>. Also by the spectral theorem for this
  family of operators (cf. [12], p. 281 and p. 383)
  ...
  concludes from a deep theorem of von Neumann and F. Riesz (cf. [12], p. 351
  again, and the footnote there) that <math|A<rsub|t>> is a function
  <math|\<varphi\><rsub|t>> of <math|U<rsub|t>>. It follows with the spectral
  theorem that
