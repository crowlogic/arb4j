...
<\body>
  ...
  Let <math|\<phi\><rsub|n><around|(|t|)>> be a complete set of orthogonal
  functions satisfying the homogeneous integral equation with symmetric
  nucleus

  <\equation>
    \<phi\><rsub|n><around|(|s|)>=\<lambda\>*<big|int><rsub|a><rsup|b>K<around|(|t-s|)>*\<phi\><rsub|n><around|(|t|)>*d*t
  </equation>

  the corresponding characteristic numbers being
  <math|\<lambda\><rsub|0>,\<lambda\><rsub|1>,\<lambda\><rsub|2>,\<ldots\>>

  Now suppose that the series <math|<big|sum><rsub|n=0><rsup|\<infty\>>\<lambda\><rsub|n>
  \<phi\><rsub|n><around|(|t|)>> is uniformly convergent when
  <math|a\<leq\>t\<leq\>b>,\ 

  <\equation>
    K<around|(|t-s|)>=<big|sum><rsub|n=1><rsup|\<infty\>>\<lambda\><rsub|n>
    \<phi\><rsub|n><around|(|t-s|)>
  </equation>

  For consider the symmetric nucleus

  <\equation>
    H<around|(|t-s|)>=K<around|(|t-s|)>-<big|sum><rsub|n=1><rsup|\<infty\>>\<lambda\><rsub|n>\<phi\><rsub|n><around|(|t-s|)>
  </equation>
  ...
  <\equation>
    \<psi\><around|(|\<alpha\>|)>=\<mu\>*<big|int><rsub|a><rsup|b>H<around|(|t-s|)>*\<psi\><around|(|t|)>*d*t
  </equation>

  which does not vanish identically.

  Multiply by <math|\<phi\><rsub|m><around|(|t|)>> and integrate and we get,
  since the series converges uniformly, we may integrate term by term and get

  <\equation>
    <big|int><rsub|a><rsup|b>\<psi\><around|(|t|)>*\<phi\><rsub|m><around|(|t|)>*d*t=\<mu\>*<big|int><rsub|a><rsup|b><big|int><rsub|a><rsup|b><around*|[|K<around|(|t-s|)>-<big|sum><rsub|n=1><rsup|\<infty\>>\<lambda\><rsub|n>\<phi\><rsub|n><around|(|t-s|)>|]>*\<psi\><around|(|t|)>*\<phi\><rsub|m><around|(|s|)>*d*t*d*s=0
  </equation>
  ...
  <\equation>
    \<psi\><around|(|\<alpha\>|)>=\<mu\>*<big|int><rsub|a><rsup|b><around*|[|K<around|(|t-s|)>-<big|sum><rsub|n=1><rsup|\<infty\>>\<lambda\><rsub|n>\<phi\><rsub|n><around|(|t-s|)>|]>*\<psi\><rsub|><around|(|t|)>*d*t
  </equation>
...
<\references>
  <\collection>
    <associate|auto-1|<tuple|?|1|TheDevelopmentOfSymmetricNuclei-WhittakerWatson11.70.tm>>
    <associate|auto-2|<tuple|1|2|TheDevelopmentOfSymmetricNuclei-WhittakerWatson11.70.tm>>
  </collection>
</references>
