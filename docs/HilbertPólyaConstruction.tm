...
<\body>
  ...
  <\definition>
    ...
    <\equation>
      <around|(|U<rsub|\<theta\>>*f|)><around|(|t|)>\<assign\><sqrt|<around|\||\<theta\><rprime|'><around|(|t|)>|\|>>*<space|0.17em>f<around|(|\<theta\><around|(|t|)>|)>*<space|2em>\<forall\>f\<in\>L<rsup|2><around|(|\<bbb-R\>|)>
    </equation>
  </definition>
  ...
  <\proof>
    ...
    <\equation>
      Z<around|(|t|)>=<sqrt|<around|\||\<theta\><rprime|'><around|(|t|)>|\|>>*<space|0.17em>X<around|(|\<theta\><around|(|t|)>|)>=<sqrt|<around|\||\<theta\><rprime|'><around|(|t|)>|\|>>*<big|int><rsub|\<bbb-R\>>e<rsup|i*\<lambda\>*\<theta\><around|(|t|)>>*<space|0.17em>\<Phi\>*<around|(|d*\<lambda\>|)>=<big|int><rsub|\<bbb-R\>><sqrt|<around|\||\<theta\><rprime|'><around|(|t|)>|\|>>*<space|0.17em>e<rsup|i*\<lambda\>*\<theta\><around|(|t|)>>*<space|0.17em>\<Phi\>*<around|(|d*\<lambda\>|)>
    </equation>
  ...
  <\definition>
    ...
    <\equation>
      <around|(|L*f|)><around|(|t|)>=t*<space|0.17em>f<around|(|t|)>
    </equation>
  ...
  <\lemma>
    ...
    holds, yielding <math|\<mu\>=<big|sum><rsub|t<rsub|0>>\<delta\><rsub|t<rsub|0>>>.
  </lemma>
