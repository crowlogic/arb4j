...
<\body>
  <doc-data|<doc-title|Gaussian Process Spectral
  Characteristics>|<doc-author|<author-data|<author-name|Stephen
  ...
  <abstract-data|<\abstract>
    ...
    "Spectral characteristics of nonstationary random processes - a critical
    review"<cite|spectralCharacteristicsOfNonstationaryRandomProcesses> in
    the form of theorems and lemmas.
  </abstract>>
  ...
  <\proof>
    ...
    real-valued processes, it must be the case that\ 
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|Z<rsup|\<ast\>><around|(|t|)>>|<cell|=<around*|[|<big|int><rsub|-\<infty\>><rsup|\<infty\>>A<around|(|t,\<omega\>|)>*e<rsup|i*\<omega\>*t>*<space|0.17em>d*\<Phi\><around|(|\<omega\>|)>|]><rsup|\<ast\>>>>|<row|<cell|>|<cell|=<big|int><rsub|-\<infty\>><rsup|\<infty\>>A<rsup|\<ast\>><around|(|t,\<omega\>|)>*e<rsup|-i*\<omega\>*t>*<space|0.17em>d*\<Phi\><rsup|\<ast\>><around|(|\<omega\>|)>>>>>>
    </equation>

    TODO: show the details by making the substitution
    <math|\<omega\>\<to\>-\<omega\>> and using the orthogonality properties
    of <math|d*\<Phi\><around|(|\<omega\>|)>>.
  </proof>
  ...
  <\theorem>
    ...
    <\equation>
      A<rsub|1><around|(|t,\<omega\>|)>=<wide|A|\<dot\>><around|(|t,\<omega\>|)>+i*\<omega\>*A<around|(|t,\<omega\>|)>
    </equation>
  </theorem>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|G<rsub|<wide|Z|\<dot\>>*<wide|Z|\<dot\>>><around|(|t,\<omega\>|)>>|<cell|=E*<around|[|\|<wide|Z|\<dot\>><around|(|t|)><around|\||<rsup|2>|\|>*\<omega\>|]>>>|<row|<cell|>|<cell|=E<around*|[|<around*|\||<big|int><rsub|-\<infty\>><rsup|\<infty\>>A<rsub|1><around|(|t,\<omega\><rprime|'>|)>*e<rsup|i*\<omega\><rprime|'>*t>*d*\<Phi\><around|(|\<omega\><rprime|'>|)>|\|><rsup|2>\|\<omega\>|]>>>|<row|<cell|>|<cell|=<around|\||A<rsub|1><around|(|t,\<omega\>|)>|\|><rsup|2>*S<rsub|X*X><around|(|\<omega\>|)>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|G<rsub|Z*<wide|Z|\<dot\>>><around|(|t,\<omega\>|)>>|<cell|=E*<around|[|Z<rsup|\<ast\>><around|(|t|)>*<wide|Z|\<dot\>><around|(|t|)>\|\<omega\>|]>>>|<row|<cell|>|<cell|=E<around*|[|<around*|(|<big|int><rsub|-\<infty\>><rsup|\<infty\>>A<rsup|\<ast\>><around|(|t,\<omega\><rprime|'>|)>*e<rsup|-i*\<omega\><rprime|'>*t>*d*\<Phi\><rsup|\<ast\>><around|(|\<omega\><rprime|'>|)>|)><around*|(|<big|int><rsub|-\<infty\>><rsup|\<infty\>>A<rsub|1><around|(|t,\<omega\><rprime|''>|)>*e<rsup|i*\<omega\><rprime|''>*t>*d*\<Phi\><around|(|\<omega\><rprime|''>|)>|)>\|\<omega\>|]>>>|<row|<cell|>|<cell|=A<rsup|\<ast\>><around|(|t,\<omega\>|)>*A<rsub|1><around|(|t,\<omega\>|)>*S<rsub|X*X><around|(|\<omega\>|)>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|\<sigma\><rsub|<wide|Z|\<dot\>>><rsup|2><around|(|t|)>>|<cell|=<big|int><rsub|-\<infty\>><rsup|\<infty\>><around|\||A<rsub|1><around|(|t,\<omega\>|)>|\|><rsup|2>*S<rsub|X*X><around|(|\<omega\>|)>*<space|0.17em>d*\<omega\>>>|<row|<cell|>|<cell|=<big|int><rsub|-\<infty\>><rsup|\<infty\>><around|\||<wide|A|\<dot\>><around|(|t,\<omega\>|)>+i*\<omega\>*A<around|(|t,\<omega\>|)>|\|><rsup|2>*S<rsub|X*X><around|(|\<omega\>|)>*<space|0.17em>d*\<omega\>>>|<row|<cell|>|<cell|=\<lambda\><rsub|2><around|(|t|)>+2*<big|int><rsub|0><rsup|\<infty\>><around|[|2*\<omega\>*<text|Im><around|[|A<rsup|\<ast\>><around|(|t,\<omega\>|)>*<wide|A|\<dot\>><around|(|t,\<omega\>|)>|]>+<around|\||<wide|A|\<dot\>><around|(|t,\<omega\>|)>|\|><rsup|2>|]>*d*\<omega\>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|Z<around|(|t|)>>|<cell|=<big|int><rsub|0><rsup|\<infty\>>A<rsup|\<ast\>><around|(|t,\<omega\>|)>*e<rsup|-i*\<omega\>*t>*<space|0.17em>d*\<Phi\>*<around|(|-\<omega\>|)>+<big|int><rsub|0><rsup|\<infty\>>A<around|(|t,\<omega\>|)>*e<rsup|i*\<omega\>*t>*<space|0.17em>d*\<Phi\><around|(|\<omega\>|)>>>|<row|<cell|>|<cell|=<big|int><rsub|0><rsup|\<infty\>><around|[|A<around|(|t,\<omega\>|)>*e<rsup|i*\<omega\>*t>+A<rsup|\<ast\>><around|(|t,\<omega\>|)>*e<rsup|-i*\<omega\>*t>|]>*<space|0.17em>d*\<Phi\><around|(|\<omega\>|\<nobracket\>>>>>>>
    </equation>

    Therefore:

    <\equation>
      <tabular|<tformat|<table|<row|<cell|i*W<around|(|t|)>>|<cell|=\<Psi\><around|(|t|)>-Z<around|(|t|)>>>|<row|<cell|>|<cell|=2*<big|int><rsub|0><rsup|\<infty\>>A<around|(|t,\<omega\>|)>*e<rsup|i*\<omega\>*t>*<space|0.17em>d*\<Phi\><around|(|\<omega\>|)>-<big|int><rsub|0><rsup|\<infty\>><around|[|A<around|(|t,\<omega\>|)>*e<rsup|i*\<omega\>*t>+A<rsup|\<ast\>><around|(|t,\<omega\>|)>*e<rsup|-i*\<omega\>*t>|]>*<space|0.17em>d*\<Phi\><around|(|\<omega\>|)>>>|<row|<cell|>|<cell|=<big|int><rsub|0><rsup|\<infty\>><around|[|A<around|(|t,\<omega\>|)>*e<rsup|i*\<omega\>*t>-A<rsup|\<ast\>><around|(|t,\<omega\>|)>*e<rsup|-i*\<omega\>*t>|]>*<space|0.17em>d*\<Phi\><around|(|\<omega\>|)>>>|<row|<cell|>|<cell|=<big|int><rsub|-\<infty\>><rsup|\<infty\>>A<around|(|t,\<omega\>|)>*e<rsup|i*\<omega\>*t><text|sgn><around|(|\<omega\>|)>*<space|0.17em>d*\<Phi\><around|(|\<omega\>|)>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|K<rsub|\<Psi\>*\<Psi\>><around|(|t<rsub|1>,t<rsub|2>|)>>|<cell|=E*<around|[|\<Psi\><rsup|\<ast\>><around|(|t<rsub|1>|)>*\<Psi\><around|(|t<rsub|2>|)>|]>>>|<row|<cell|>|<cell|=4*E<around*|[|<big|int><rsub|0><rsup|\<infty\>><big|int><rsub|0><rsup|\<infty\>>A<rsup|\<ast\>><around|(|t<rsub|1>,\<omega\><rsub|1>|)>*A<around|(|t<rsub|2>,\<omega\><rsub|2>|)>*e<rsup|-i*\<omega\><rsub|1>*t<rsub|1>+i*\<omega\><rsub|2>*t<rsub|2>>*d*\<Phi\><rsup|\<ast\>><around|(|\<omega\><rsub|1>|)>*d*\<Phi\><around|(|\<omega\><rsub|2>|)>|]>>>|<row|<cell|>|<cell|=4*<big|int><rsub|0><rsup|\<infty\>>A<rsup|\<ast\>><around|(|t<rsub|1>,\<omega\>|)>*A<around|(|t<rsub|2>,\<omega\>|)>*e<rsup|i*\<omega\>*<around|(|t<rsub|2>-t<rsub|1>|)>>*S<rsub|X*X><around|(|\<omega\>|)>*<space|0.17em>d*\<omega\>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      A<rsub|j><around|(|t,\<omega\>|)>=i*\<omega\>*A<rsub|j-1><around|(|t,\<omega\>|)>+<wide|A|\<dot\>><rsub|j-1><around|(|t,\<omega\>|)>
    </equation>

    \ with <math|>

    <\equation>
      A<rsub|0><around|(|t,\<omega\>|)>=A<around|(|t,\<omega\>|)>
    </equation>
  ...
  <\corollary>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|c<rsub|00><around|(|t|)>>|<cell|=\<sigma\><rsub|Z><rsup|2><around|(|t|)>=2*<big|int><rsub|0><rsup|\<infty\>>G<rsub|Z*Z><around|(|t,\<omega\>|)>*<space|0.17em>d*\<omega\>>>|<row|<cell|c<rsub|11><around|(|t|)>>|<cell|=\<sigma\><rsub|<wide|Z|\<dot\>>><rsup|2><around|(|t|)>=2*<big|int><rsub|0><rsup|\<infty\>>G<rsub|<wide|Z|\<dot\>>*<wide|Z|\<dot\>>><around|(|t,\<omega\>|)>*<space|0.17em>d*\<omega\>>>|<row|<cell|c<rsub|01><around|(|t|)>>|<cell|=-2*i*<big|int><rsub|0><rsup|\<infty\>>G<rsub|Z*<wide|Z|\<dot\>>><around|(|t,\<omega\>|)>*<space|0.17em>d*\<omega\>>>>>>
    </equation>
  </corollary>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|c<rsub|00><around|(|t|)>>|<cell|=<frac|<around|(|-1|)><rsup|0>*i<rsup|0+0>|2>*K<rsub|\<Psi\>*\<Psi\>><around|(|t,t|)>=<frac|1|2>*K<rsub|\<Psi\>*\<Psi\>><around|(|t,t|)>>>|<row|<cell|>|<cell|=<frac|1|2>\<cdot\>4*<big|int><rsub|0><rsup|\<infty\>><around|\||A<around|(|t,\<omega\>|)>|\|><rsup|2>*S<rsub|X*X><around|(|\<omega\>|)>*<space|0.17em>d*\<omega\>>>|<row|<cell|>|<cell|=2*<big|int><rsub|0><rsup|\<infty\>>G<rsub|Zq*Z><around|(|t,\<omega\>|)>*<space|0.17em>d*\<omega\>=\<sigma\><rsub|Z><rsup|2><around|(|t|)>>>>>>
    </equation>

    For <math|c<rsub|11><around|(|t|)>>:

    <\equation>
      <tabular|<tformat|<table|<row|<cell|c<rsub|11><around|(|t|)>>|<cell|=<frac|<around|(|-1|)><rsup|1>*i<rsup|1+1>|2>*K<rsub|<wide|\<Psi\>|\<dot\>>*<wide|\<Psi\>|\<dot\>>><around|(|t,t|)>>>|<row|<cell|>|<cell|=<frac|-1\<cdot\><around|(|-1|)>|2>*K<rsub|<wide|\<Psi\>|\<dot\>>*<wide|\<Psi\>|\<dot\>>><around|(|t,t|)>>>|<row|<cell|>|<cell|=<frac|1|2>*K<rsub|<wide|\<Psi\>|\<dot\>>*<wide|\<Psi\>|\<dot\>>><around|(|t,t|)>>>|<row|<cell|>|<cell|=2*<big|int><rsub|0><rsup|\<infty\>>G<rsub|<wide|Z|\<dot\>>*<wide|Z|\<dot\>>><around|(|t,\<omega\>|)>*<space|0.17em>d*\<omega\>>>|<row|<cell|>|<cell|=\<sigma\><rsub|<wide|Z|\<dot\>>><rsup|2><around|(|t|)>>>>>>
    </equation>

    For <math|c<rsub|01><around|(|t|)>>:

    <\equation>
      <tabular|<tformat|<table|<row|<cell|c<rsub|01><around|(|t|)>>|<cell|=<frac|<around|(|-1|)><rsup|1>*i<rsup|0+1>|2>*K<rsub|\<Psi\>*<wide|\<Psi\>|\<dot\>>><around|(|t,t|)>=<frac|-i|2>*K<rsub|\<Psi\>*<wide|\<Psi\>|\<dot\>>><around|(|t,t|)>>>|<row|<cell|>|<cell|=-2*i*<big|int><rsub|0><rsup|\<infty\>>G<rsub|Z*<wide|Z|\<dot\>>><around|(|t,\<omega\>|)>*<space|0.17em>d*\<omega\>>>>>>
    </equation>
  </proof>
  ...
  <\definition>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|Z<around|(|t|)>>|<cell|=V<around|(|t|)>*cos
      <around|(|U<around|(|t|)>|)>>>|<row|<cell|W<around|(|t|)>>|<cell|=V<around|(|t|)>*sin
      <around|(|U<around|(|t|)>|)>>>|<row|<cell|V<around|(|t|)>>|<cell|=<around|\||\<Psi\><around|(|t|)>|\|>=<sqrt|Z<rsup|2><around|(|t|)>+W<rsup|2><around|(|t|)>>>>>>>
    </equation>
  </definition>
  ...
  <\theorem>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|p<rsub|V><around|(|\<nu\>,t|)>>|<cell|=<frac|\<nu\>|\<sigma\><rsub|Z><rsup|2><around|(|t|)>>*e<rsup|-<frac|\<nu\><rsup|2>|2*\<sigma\><rsub|Z><rsup|2><around|(|t|)>>>>>|<row|<cell|p<rsub|U><around|(|u,t|)>>|<cell|=<frac|1|2*\<pi\>>>>|<row|<cell|p<rsub|<wide|U|\<dot\>>><around|(|<wide|u|\<dot\>>,t|)>>|<cell|=<frac|\<sigma\><rsub|<wide|Z|\<dot\>>><rsup|2><around|(|t|)>*\<Delta\><rsup|2><around|(|t|)>|2*\<sigma\><rsub|Z><rsup|2><around|(|t|)>>*<around*|[|<frac|\<sigma\><rsub|<wide|Z|\<dot\>>><rsup|2><around|(|t|)>*\<Delta\><rsup|2><around|(|t|)>|\<sigma\><rsub|Z><rsup|2><around|(|t|)>>+<around|(|<wide|u|\<dot\>>-\<Omega\><around|(|t|)>|)><rsup|2>|]><rsup|-<frac|3|2>>>>>>>
    </equation>

    where\ 

    <\equation>
      \<Omega\><around|(|t|)>=<frac|<text|Re><around|[|c<rsub|01><around|(|t|)>|]>|c<rsub|00><around|(|t|)>>
    </equation>

    \ and

    <\equation>
      \<Delta\><around|(|t|)>=<sqrt|1-<frac|<around|\||c<rsub|01><around|(|t|)>|\|><rsup|2>|c<rsub|00><around|(|t|)>*c<rsub|11><around|(|t|)>>>
    </equation>
  </theorem>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|Z<around|(|t|)>>|<cell|=V<around|(|t|)>*cos
      <around|(|U<around|(|t|)>|)>>>|<row|<cell|W<around|(|t|)>>|<cell|=V<around|(|t|)>*sin
      <around|(|U<around|(|t|)>|\<nobracket\>>>>|<row|<cell|<wide|Z|\<dot\>><around|(|t|)>>|<cell|=<wide|V|\<dot\>><around|(|t|)>*cos
      <around|(|U<around|(|t|)>|)>-V<around|(|t|)><wide|U|\<dot\>><around|(|t|)>*sin
      <around|(|U<around|(|t|)>|)>>>|<row|<cell|<wide|W|\<dot\>><around|(|t|)>>|<cell|=<wide|V|\<dot\>><around|(|t|)>*sin
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|p<rsub|V,U><around|(|v,u,t|)>>|<cell|=p<rsub|Z,W><around|(|v*cos
      <around|(|u|)>,v*sin <around|(|u|)>,t|)>\<cdot\>v>>|<row|<cell|>|<cell|=<frac|v|2*\<pi\>*\<sigma\><rsub|Z><rsup|2><around|(|t|)>>*e<rsup|-<frac|v<rsup|2>|2*\<sigma\><rsub|Z><rsup|2><around|(|t|)>>>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|\<Psi\><rsup|<around|(|j|)>><around|(|t|)>>|<cell|=Z<rsup|<around|(|j|)>><around|(|t|)>+i*W<rsup|<around|(|j|)>><around|(|t|)>>>|<row|<cell|E<around|[|<around|\||\<Psi\><rsup|<around|(|j|)>><around|(|t|)>|\|><rsup|2>|]>>|<cell|=E<around|[|<around|\||Z<rsup|<around|(|j|)>><around|(|t|)>|\|><rsup|2>|]>+E<around|[|<around|\||W<rsup|<around|(|j|)>><around|(|t|)>|\|><rsup|2>|]>>>|<row|<cell|>|<cell|=2*E<around|[|<around|\||Z<rsup|<around|(|j|)>><around|(|t|)>|\|><rsup|2>|\<nobracket\>>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      A<around|(|t,\<omega\>|)>=A<around|(|t|)>
    </equation>

    , the EPSD becomes\ 

    <\equation>
      G<rsub|Z*Z><around|(|t,\<omega\>|)>=A<rsup|2><around|(|t|)>*S<rsub|X*X><around|(|\<omega\>|)>
    </equation>
  ...
  <thebibliography|1|<bibitem-with-key|1|spectralCharacteristicsOfNonstationaryRandomProcesses>L.D.<nbsp>Lutes
...
<\references>
  <\collection>
    ...
    <associate|auto-10|<tuple|10|11|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-11|<tuple|55|11|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-2|<tuple|2|2|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-3|<tuple|3|3|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-4|<tuple|4|3|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-5|<tuple|5|5|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-6|<tuple|6|5|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-7|<tuple|7|7|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-8|<tuple|8|9|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|auto-9|<tuple|9|10|../../.TeXmacs/texts/scratch/no_name_30.tm>>
    <associate|bib-spectralCharacteristicsOfNonstationaryRandomProcesses|<tuple|1|11|../../.TeXmacs/texts/scratch/no_name_30.tm>>
  </collection>
</references>
