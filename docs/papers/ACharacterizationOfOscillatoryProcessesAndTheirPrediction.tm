...
<\body>
  ...
  <\definition>
    ...
    <\itemize>
      <item*|(a)><math|<math-up|Dom><around|(|A|)>\<supset\><around|{|y<around|(|s|)>,-\<infty\>\<less\>s\<less\>+\<infty\>|}>>

      <item*|(b)><math|x<around|(|t|)>=<around|(|A*y|)><around|(|t|)>\<forall\>t\<in\>\<bbb-R\>>
    </itemize>
  </definition>
  ...
  <\definition>
    ...
    <\enumerate>
      <item><math|\<Phi\><around|(|\<cdummy\>|)>> is an orthogonal countably
      ...
      <item>for each <math|t\<in\>R>, <math|<big|int><rsub|-\<infty\>><rsup|+\<infty\>><around|\||a<rsub|t><around|(|\<lambda\>|)>|\|><rsup|2>*d*\<rho\><around|(|\<lambda\>|)>\<less\>\<infty\>>
      where
    </enumerate>

    <\equation>
      \<rho\><around|(|A|)>=<around|(|\<Phi\><around|(|A|)>,\<Phi\><around|(|A|)>|)><rsub|L<rsub|2><around|(|\<Omega\>|)>><label|eq:rho>
    </equation>
  ...
  <\definition>
    ...
    <math|\<Phi\><around|(|A|)>=<around|(|E<around|(|A|)>*y|)><around|(|0|)>>
    ...
    <math|H<rsub|y>*<around|(|+\<infty\>|)>=\<cal-S\><around|{|<around|(|U<rsub|t>*y|)><around|(|0|)>,t\<in\>R|}>>.
  </definition>
  ...
  <\theorem>
    ...
    <\equation>
      <around|(|A*U<rsub|s>*h|)><around|(|t|)>=<around|(|U<rsub|s>*A*h|)><around|(|t|)>\<forall\>s\<in\>\<bbb-R\>
    </equation>

    and <math|h\<in\><math-up|Dom><around|(|A|)>>.
  </theorem>
...
<\references>
  <\collection>
    <associate|auto-1|<tuple|11|6>>
    <associate|bib-Abdrabbo|<tuple|Abdrabbo|6>>
    <associate|bib-Cramer|<tuple|Cramer|6>>
    <associate|bib-Doob|<tuple|Doob|6>>
    <associate|bib-Dunford|<tuple|Dunford|6>>
    <associate|bib-Karhunen|<tuple|Karhunen|6>>
    <associate|bib-Kolmogorov|<tuple|Kolmogorov|6>>
    <associate|bib-Masani|<tuple|Masani|6>>
    <associate|bib-Priestley|<tuple|Priestley|6>>
    <associate|bib-Riesz|<tuple|Riesz|6>>
    <associate|cor:equivalence|<tuple|8|5>>
    <associate|cor:moving_avg|<tuple|10|5>>
    <associate|cor:multiplicity|<tuple|9|5>>
    <associate|cor:nondeterministic|<tuple|7|5>>
    ...
    <associate|rem:spectrum|<tuple|6|4>>
    <associate|stationaryCurve|<tuple|2|1>>
    <associate|thm:characterization|<tuple|5|3>>
  </collection>
</references>
