...
<\body>
  ...
  <\equation>
    <big|int><rsub|0><rsup|\<infty\>>K*<around|(|t-s|)>*\<phi\><rsub|k><around|(|t|)>*<space|0.17em>d*t=\<lambda\><rsub|k>*\<phi\><rsub|k><around|(|s|)>
  </equation>
  ...
  <\enumerate>
    ...
    <item>Recall our definitions:

    <\align>
      <tformat|<table|<row|<cell|G<rsub|j,n><around|(|s|)>>|<cell|=<big|int><rsub|0><rsup|\<infty\>>\<psi\><rsub|j>*<around|(|t-s|)>*\<psi\><rsub|n><around|(|t|)>*d*t<eq-number>>>|<row|<cell|b<rsub|m,n>>|<cell|=<big|sum><rsub|j=0><rsup|\<infty\>><big|int><rsub|0><rsup|\<infty\>>G<rsub|j,n><around|(|s|)>*\<psi\><rsub|m><around|(|s|)>*d*s<eq-number>>>>>
    </align>

    <item>Rewrite the left-hand side:

    <\equation>
      <big|sum><rsub|n=0><rsup|\<infty\>>c<rsub|n,k><around*|[|<big|sum><rsub|j=0><rsup|\<infty\>>G<rsub|j,n><around|(|s|)>|]>
    </equation>

    <item>Project onto <math|\<psi\><rsub|m><around|(|s|)>> by multiplying by
    <math|\<psi\><rsub|m><around|(|s|)>> and integrating over <math|s>:

    <\align>
      <tformat|<table|<row|<cell|>|<cell|<big|int><rsub|0><rsup|\<infty\>>\<psi\><rsub|m><around|(|s|)><around*|[|<big|sum><rsub|n=0><rsup|\<infty\>>c<rsub|n,k><around*|[|<big|sum><rsub|j=0><rsup|\<infty\>>G<rsub|j,n><around|(|s|)>|]>|]>*d*s<eq-number>>>|<row|<cell|>|<cell|=<big|sum><rsub|n=0><rsup|\<infty\>>c<rsub|n,k><around*|[|<big|sum><rsub|j=0><rsup|\<infty\>><big|int><rsub|0><rsup|\<infty\>>G<rsub|j,n><around|(|s|)>*\<psi\><rsub|m><around|(|s|)>*d*s|]><eq-number>>>|<row|<cell|>|<cell|=<big|sum><rsub|n=0><rsup|\<infty\>>c<rsub|n,k>*b<rsub|m,n><eq-number>>>|<row|<cell|>|<cell|=<around|(|B*<wide|c|\<vect\>><rsub|k>|)><rsub|m><eq-number>>>|<row|<cell|>|<cell|=\<lambda\><rsub|k><around|(|<wide|c|\<vect\>><rsub|k>|)><rsub|m><eq-number>>>|<row|<cell|>|<cell|=\<lambda\><rsub|k>*c<rsub|m,k><eq-number>>>>>
    </align>

    <item>On the other hand, projecting <math|\<phi\><rsub|k><around|(|s|)>>
    onto <math|\<psi\><rsub|m><around|(|s|)>>:

    <\equation>
      <big|int><rsub|0><rsup|\<infty\>>\<psi\><rsub|m><around|(|s|)>*\<phi\><rsub|k><around|(|s|)>*d*s=<big|int><rsub|0><rsup|\<infty\>>\<psi\><rsub|m><around|(|s|)><around*|[|<big|sum><rsub|n=0><rsup|\<infty\>>c<rsub|n,k>*\<psi\><rsub|n><around|(|s|)>|]>*d*s=c<rsub|m,k>
    </equation>

    <item>Comparing the results from steps 7 and 8, we see that:

    <\equation>
      <big|int><rsub|0><rsup|\<infty\>>\<psi\><rsub|m><around|(|s|)><around*|[|<big|int><rsub|0><rsup|\<infty\>>K*<around|(|t-s|)>*\<phi\><rsub|k><around|(|t|)>*d*t|]>*d*s=\<lambda\><rsub|k>*<big|int><rsub|0><rsup|\<infty\>>\<psi\><rsub|m><around|(|s|)>*\<phi\><rsub|k><around|(|s|)>*d*s
    </equation>
...
<\references>
  <\collection>
    ...
    <associate|auto-2|<tuple|2|1|../../.TeXmacs/texts/scratch/no_name_59.tm>>
    <associate|auto-3|<tuple|3|1|../../.TeXmacs/texts/scratch/no_name_59.tm>>
    <associate|auto-4|<tuple|4|3|../../.TeXmacs/texts/scratch/no_name_59.tm>>
  </collection>
</references>
