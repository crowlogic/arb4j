...
<\body>
  ...
  <\definition>
    ...
    <\enumerate>
      ...
      <\equation>
        <tabular|<tformat|<table|<row|<cell|<around|(|P<rsub|\<theta\>><rsup|2>*Y|)><rsub|t>>|<cell|=<around|(|P<rsub|\<theta\>>*<around|(|P<rsub|\<theta\>>*Y|)>|)><rsub|t>>>|<row|<cell|>|<cell|=P<rsub|\<theta\>><around|(|Y<rsub|(\<cdot\>,\<theta\>(\<cdot\><around|)||)>>|)><rsub|t>>>|<row|<cell|>|<cell|=Y<rsub|<around|(|t,\<theta\><around|(|t|)>|)>>>>|<row|<cell|>|<cell|=<around|(|P<rsub|\<theta\>>*Y|)><rsub|t>>>>>>
      </equation>
      ...
      <\equation>
        <around|\<langle\>|P<rsub|\<theta\>>*Y,Z|\<rangle\>>=<around|\<langle\>|Y,P<rsub|\<theta\>>*Z|\<rangle\>>
      </equation>
    </enumerate>
  </definition>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|e<rsup|i*\<lambda\>*\<theta\><around|(|t|)>>>|<cell|=e<rsup|i*\<lambda\>*\<theta\><around|(|t|)>>\<cdot\><frac|e<rsup|i*\<lambda\>*t>|e<rsup|i*\<lambda\>*t>>>>|<row|<cell|>|<cell|=e<rsup|i*\<lambda\>*t>\<cdot\>e<rsup|i*\<lambda\>*\<theta\><around|(|t|)>-i*\<lambda\>*t>>>|<row|<cell|>|<cell|=e<rsup|i*\<lambda\>*t>\<cdot\>e<rsup|i*\<lambda\>*<around|(|\<theta\><around|(|t|)>-t|)>>>>>>>
    </equation>

    <with|font-series|bold|Step 3:> Substituting this factorization back:

    <\equation>
      <tabular|<tformat|<table|<row|<cell|X<rsub|t>>|<cell|=<big|int><rsub|\<bbb-R\>>e<rsup|i*\<lambda\>*\<theta\><around|(|t|)>>*d*Z<rsub|0><around|(|\<lambda\>|)>>>|<row|<cell|>|<cell|=<big|int><rsub|\<bbb-R\>>e<rsup|i*\<lambda\>*t>\<cdot\>e<rsup|i*\<lambda\>*<around|(|\<theta\><around|(|t|)>-t|)>>*d*Z<rsub|0><around|(|\<lambda\>|)>>>>>>
    </equation>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|h<rsub|t><around|(|\<lambda\>|)>>|<cell|=<around|\||A<rsub|t><around|(|\<lambda\>|)>|\|><rsup|2>\<cdot\>f<rsub|0><around|(|\<lambda\>|)>>>|<row|<cell|>|<cell|=<around|\||e<rsup|i*\<lambda\>*<around|(|\<theta\><around|(|t|)>-t|)>>|\|><rsup|2>\<cdot\>f<rsub|0><around|(|\<lambda\>|)>>>|<row|<cell|>|<cell|=1\<cdot\>f<rsub|0><around|(|\<lambda\>|)>>>|<row|<cell|>|<cell|=f<rsub|0><around|(|\<lambda\>|)>>>>>>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|<around|(|P<rsub|\<theta\>>*Y|)><rsub|t>>|<cell|=Y<rsub|<around|(|t,\<theta\><around|(|t|)>|)>>>>|<row|<cell|>|<cell|=<big|int><rsub|\<bbb-R\>>e<rsup|i*\<lambda\>*\<theta\><around|(|t|)>>*d*Z<rsub|0><around|(|\<lambda\>|)>>>|<row|<cell|>|<cell|=X<rsub|t>>>>>>
    </equation>
  ...
  <\corollary>
    ...
    <\enumerate>
      ...
      <item>It has evolutionary spectral representation <math|>

      <\equation>
        X<rsub|t>=<big|int><rsub|\<bbb-R\>>e<rsup|i*\<lambda\>*<around|(|\<theta\><around|(|t|)>-t|)>>*e<rsup|i*\<lambda\>*t>*d*Z<rsub|0><around|(|\<lambda\>|)>
      </equation>

      <item>It is the projection of a stationary process <math|>
