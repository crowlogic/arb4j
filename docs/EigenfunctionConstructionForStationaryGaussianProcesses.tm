...
<\body>
  ...
  <\definition>
    ...
    <\equation>
      <around|\<langle\>|f,g|\<rangle\>><rsub|p>=<big|int><rsub|0><rsup|\<infty\>>f<around|(|x|)>*g<around|(|x|)>*p<around|(|x|)>*\<mathd\>*x
    </equation>
  ...
  <\definition>
    ...
    <\equation>
      \<cal-F\><around|[|f|]><around|(|\<omega\>|)>=<big|int><rsub|0><rsup|\<infty\>>f<around|(|x|)>*e<rsup|-i*\<omega\>*x>*d*x
    </equation>

    <\equation>
      \<cal-F\><rsup|-1><around|[|g|]><around|(|x|)>=<frac|1|2*\<pi\>>*<big|int><rsub|0><rsup|\<infty\>>g<around|(|\<omega\>|)>*e<rsup|i*\<omega\>*x>*d*\<omega\>
    </equation>
  </definition>

  <\theorem>
    The eigenfunctions of a stationary gaussian process on the half-line are
    given by the orthogonal complement of the inverse Fourier transforms of
    the polynomials orthogonal to the square root of the spectral density.
  </theorem>

  <\proof>
    Let <math|S<around|(|\<omega\>|)>> be the spectral density of a
    stationary Gaussian process on [0,\<infty\>),
    <math|K*<around|(|x-y|)>=<around|(|\<cal-F\><rsup|-1><around|[|S<around|(|\<omega\>|)>|]>|)>*<around|(|x-y|)>>
    ...
    <\equation>
      <big|int><rsub|0><rsup|\<infty\>>Q<rsub|k><around|(|\<omega\>|)>*Q<rsub|j><around|(|\<omega\>|)><sqrt|S<around|(|\<omega\>|)>>*<space|0.17em>d*\<omega\>=0\<forall\>k\<neq\>j
    </equation>

    Let

    <\equation>
      \<psi\><rsub|k><around|(|x|)>=\<cal-F\><rsup|-1><around|[|Q<rsub|k><around|(|\<omega\>|)>|]><around|(|x|)><label|ift>
    </equation>
    ...
    <\equation>
      T<around|[|f|]><around|(|y|)>=<big|int><rsub|0><rsup|\<infty\>>K*<around|(|x-y|)>*f<around|(|x|)>*\<mathd\>*x
    </equation>

    to <math|\<psi\><rsub|k><rsup|\<perp\>><around|(|x|)>> to get

    <\equation>
      <tabular*|<tformat|<cwith|1|-1|1|1|cell-halign|l>|<cwith|1|-1|1|1|cell-lborder|0ln>|<cwith|1|-1|2|2|cell-halign|l>|<cwith|1|-1|2|2|cell-rborder|0ln>|<table|<row|<cell|T<around|[|\<psi\><rsub|k><rsup|\<perp\>>|]><around|(|x|)>>|<cell|=<big|int><rsub|0><rsup|\<infty\>>K*<around|(|x-y|)>*\<psi\><rsub|k><rsup|\<perp\>><around|(|y|)>*\<mathd\>*y>>|<row|<cell|>|<cell|=\<cal-F\><rsup|-1>*<around|[|S<around|(|\<omega\>|)>\<cdot\>\<cal-F\><around|[|\<psi\><rsub|k><rsup|\<perp\>>|]><around|(|\<omega\>|)>|]><around|(|x|)>>>>>><label|T>
    </equation>

    where the equality is due to the convolution theorem on the half-line. By
    the linearity of the Fourier transform and the Gram-Schmidt construction
    in Equation (<reference|eig>):
    ...
    <\equation>
      T<around|[|\<psi\><rsub|k><rsup|\<perp\>>|]><around|(|x|)>=\<cal-F\><rsup|-1>*<around|[|S<around|(|\<omega\>|)>\<cdot\><around|(|Q<rsub|k><around|(|\<omega\>|)>-<big|sum><rsub|j=1><rsup|k-1>c<rsub|j>*\<cal-F\><around|[|\<psi\><rsub|j><rsup|\<perp\>>|]><around|(|\<omega\>|)>|)>|]><around|(|x|)>
    </equation>
    ...
    <\equation>
      T<around|[|\<psi\><rsub|k><rsup|\<perp\>>|]><around|(|x|)>=\<lambda\><rsub|k>*\<psi\><rsub|k><around|(|x|)>-<big|sum><rsub|j=1><rsup|k-1>c<rsub|j>*\<lambda\><rsub|j>*\<psi\><rsub|j><rsup|\<perp\>><around|(|x|)>
    </equation>
    ...
    <\equation>
      T<around|[|\<psi\><rsub|k><rsup|\<perp\>>|]><around|(|x|)>=\<lambda\><rsub|k>*\<psi\><rsub|k><rsup|\<perp\>><around|(|x|)>
    </equation>

    Thus <math|\<psi\><rsub|k><rsup|\<perp\>><around|(|x|)>> is an
    eigenfunction of the kernel operator with eigenvalue
    <math|\<lambda\><rsub|k>\<gtr\>0> on the half-line [0,\<infty\>).
  </proof>
</body>
