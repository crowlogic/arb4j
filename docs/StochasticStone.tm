...
<\body>
  ...
  <\proof>
    ...
    <\enumerate-numeric>
      <item><with|font-series|bold|Construct the commutative
      <math|C<rsup|\<ast\>>>-algebra.> Let <math|\<cal-A\>> be the
      norm-closed <math|\<ast\>>-subalgebra of <math|\<cal-L\><around|(|H|)>>
      generated by <math|A> and <math|I>. Since <math|A> is self-adjoint,
      every element of <math|\<cal-A\>> is a norm limit of polynomials in
      <math|A> and <math|A<rsup|\<ast\>>=A>, hence <math|\<cal-A\>> is
      commutative.

      <item><with|font-series|bold|Gelfand transform.> By the Gelfand-Naimark
      ...
      <math|\<ast\>>-isomorphism. Under this isomorphism, <math|A>
      corresponds to a continuous function
      <math|<wide|A|^>\<in\>C<around|(|X|)>> which is real-valued (since
      <math|A> is self-adjoint). The norm
      <math|<around|\<\|\|\>|<wide|A|^>|\<\|\|\>><rsub|\<infty\>>=<around|\<\|\|\>|A|\<\|\|\>>>.

      <item><with|font-series|bold|Representation on <math|C<around|(|X|)>>.>
      There exists a unitary <math|U:H\<to\>L<rsup|2><around|(|X,\<mu\>|)>>
      for some regular Borel measure <math|\<mu\>> on <math|X> such that
      ...
      <item><with|font-series|bold|Define the PVM.> For a Borel set
      ...
      <math|L<rsup|2><around|(|X,\<mu\>|)>>. This is an orthogonal
      projection. The map <math|E<rsub|A>> is a PVM since
      <math|M<rsub|<1><rsub|S>>> for Borel <math|S\<subset\>X> form a PVM.

      <item><with|font-series|bold|Verification.> We have
      ...
      <item><with|font-series|bold|Uniqueness.> Suppose
  ...
  <\proof>
    <\enumerate-numeric>
      <item><with|font-series|bold|Cayley transform.> Define the Cayley
      transform\ 
      ...
      <\equation>
        <tabular|<tformat|<table|<row|<cell|<around|\<\|\|\>|U*<around|(|A+i*I|)>*\<phi\>|\<\|\|\>><rsup|2>>|<cell|=<around|\<\|\|\>|<around|(|A-i*I|)>*\<phi\>|\<\|\|\>><rsup|2>>>|<row|<cell|>|<cell|=<ip|<around|(|A-i*I|)>*\<phi\>|<around|(|A-i*I|)>*\<phi\>>>>|<row|<cell|>|<cell|=<ip|<around|(|A<rsup|2>+I|)>*\<phi\>|\<phi\>>>>|<row|<cell|>|<cell|=<ip|<around|(|A+i*I|)>*\<phi\>|<around|(|A+i*I|)>*\<phi\>>>>|<row|<cell|>|<cell|=<around|\<\|\|\>|<around|(|A+i*I|)>*\<phi\>|\<\|\|\>><rsup|2>>>>>>
      </equation>
      ...
      <item><with|font-series|bold|Spectral theorem for <math|U>.> By Theorem
      ...
      <item><with|font-series|bold|Inverse Cayley transform.> The inverse
      Cayley transform is

      <\equation>
        A=i*<around|(|I+U|)>*<around|(|I-U|)><rsup|-1>
      </equation>
      ...
      <item><with|font-series|bold|Verification of the spectral integral.> We
      have
      ...
      <item><with|font-series|bold|Uniqueness.> Uniqueness follows from the
      uniqueness of the spectral theorem for the unitary operator <math|U>
      and the bijection between PVMs for <math|U> and <math|A> via the Cayley
      transform
    </enumerate-numeric>
  </proof>
