...
public class HistogramSample extends
                             Application
{
  ...
  private final Histogram  dataSet1      = new Histogram("myHistogram1",
                                                         N_BINS,
                                                         0.0,
                                                         20.0,
                                                         BINS_ALIGNED_WITH_BOUNDARY);
  private final Histogram  dataSet2      = new Histogram("myHistogram2",
                                                         N_BINS,
                                                         0.0,
                                                         20.0,
                                                         BINS_ALIGNED_WITH_BOUNDARY);
  private final Histogram  dataSet3      = new Histogram("myHistogram3",
                                                         xBins);                                              // custom,
                                                                                                              // non-equidistant
                                                                                                              // histogram
  ...
  public void start(final Stage primaryStage)
  {
    ...
    final XYChart chart = new XYChart(xAxis2,
                                      yAxis);
