                                ...
                                Application
{
  ...
  private static DataSet createData()
  {
    ...
    return new DataSetBuilder("demoDataSet").setValues(DataSet.DIM_X, x)
                                            .setValues(DataSet.DIM_Y, y)
                                            .setValues(DataSet.DIM_Z, z)
                                            .build();
  }
  ...
  public DataSet readImage()
  {
    ...
    try ( BufferedReader reader = new BufferedReader(new InputStreamReader(Objects.requireNonNull(ContourChartSample.class.getResourceAsStream("./testdata/image.txt")))))
    {
      ...
      String skipLine; // NOPMD variable is needed to skip/check line that contains the dimension of
                       // the following
      ...
      return new DataSetBuilder("contour data").setValues(DataSet.DIM_X, xValues)
                                               .setValues(DataSet.DIM_Y, yValues)
                                               .setValues(DataSet.DIM_Z, zValues)
                                               .build();
  ...
  public void start(final Stage primaryStage)
  {
    ...
    final Slider  nSegmentSlider       = new Slider(0,
                                                    10_000,
                                                    500);                  // number of contour segments
    final Slider  minHexSizeSlider     = new Slider(1,
                                                    100,
                                                    5);                    // number of contour segments
    final XYChart chartPane1           = getChartPane(nCountourLevelSlider,
                                                      nSegmentSlider,
                                                      minHexSizeSlider,
                                                      ContourType.CONTOUR);
    final XYChart chartPane2           = getChartPane(nCountourLevelSlider,
                                                      nSegmentSlider,
                                                      minHexSizeSlider,
                                                      ContourType.HEATMAP);
    final HBox    hBox                 = new HBox(chartPane1,
                                                  chartPane2);
    ...
    final HBox hBoxSlider1 = new HBox(new Label("n countours:"),
                                      nCountourLevelSlider);
    ...
    final HBox hBoxSlider2 = new HBox(new Label("n segments :"),
                                      nSegmentSlider);
    ...
    final HBox hBoxSlider3 = new HBox(new Label("minHexSizeSize :"),
                                      minHexSizeSlider);
    ...
    final HBox  parameter = new HBox(new Label("Countour1: "),
                                     cb1,
                                     colorGradient1,
                                     new Label(" Countour2: "),
                                     cb2,
