...
/**
 * example to illustrate bubble- and scatter-type plot using either the
 * DataSetError interface or (more customisable) DataStyle Marker interface.
 *
 * @author rstein
 */
public class ScatterAndBubbleRendererSample extends
                                            Application
{
  ...
  public void start(final Stage primaryStage)
  {
    ...
    Map<String, Double> sortedGDP       = gdpPerCapita.entrySet()
                                                      .stream()
                                                      ...
                                                      .collect(Collectors.toMap(Entry::getKey,
                                                                                ...
                                                                                (e1, e2) -> e2,
                                                                                LinkedHashMap::new));
    // N.B. for the time the being the Zoomer plugin and Data reduction algorithm
    // require
    ...
    for (Entry<String, Double> entry : sortedGDP.entrySet())
    {
      ...
      // N.B. Tip: Math.sqrt(..) since for the observer the surface are is more
    ...
    primaryStage.setScene(new Scene(chart1,
                                    800,
                                    600));
    ...
    // or via global default, this also allows to set custom marker implementing the
    // 'Marker' interface
    ...
    secondaryStage.setScene(new Scene(chart2,
                                      800,
                                      600));
  ...
  {
    DefaultNumericAxis xAxis = new DefaultNumericAxis("GDP",
                                                      "USD/capita");
    ...
    xAxis.setMin(15_000);
    xAxis.setMax(75_000);
    DefaultNumericAxis yAxis = new DefaultNumericAxis("life-expectancy",
                                                      "years");
