...
public class FifoDoubleErrorDataSetSample
{
  ...
  public static void main(final String[] args)
  {
    ...
    final FifoDoubleErrorDataSet     buffer1          = new FifoDoubleErrorDataSet("test",
                                                                                   bufferLength,
                                                                                   10);
    final CircularDoubleErrorDataSet buffer2          = new CircularDoubleErrorDataSet("test",
                                                                                       bufferLength);
    ...
    for (int i = 0; i < fillBufferLength; i++)
    {
      ...
      final String msg  = String.format("%2d - [ %2d vs. %2d , %2d vs. %2d] - length = %2d vs %2d",
                                        i,
                                        (int) buffer1.getX(0),
                                        (int) buffer2.getX(0),
                                        (int) buffer1.getX(max1),
                                        (int) buffer2.getX(max2),
                                        max1,
                                        max2);
    ...
    final FifoDoubleErrorDataSet buffer3 = new FifoDoubleErrorDataSet("test",
                                                                      1000,
                                                                      100);
