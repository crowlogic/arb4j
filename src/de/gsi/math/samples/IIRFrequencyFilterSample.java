 ...
 * @author rstein
 */
public class IIRFrequencyFilterSample extends
                                      AbstractDemoApplication
{
  ...
  private DemoChart getDemoChartBessel()
  {
    ...
    chart.getRenderer(0)
         .getDatasets()
         .addAll(DataSetMath.normalisedMagnitudeSpectrumDecibel(lowPass),
  ...
  private DemoChart getDemoChartChebychevI()
  {
    ...
    iirBandPass.bandPass(ORDER,
                         1.0,
                         0.5 * (F_CUT_LOW + F_CUT_HIGH),
                         (F_CUT_HIGH - F_CUT_LOW),
                         ALLOWED_IN_BAND_RIPPLE_DB);

    final ChebyshevI iirBandStop = new ChebyshevI();
    iirBandStop.bandStop(ORDER,
                         1.0,
                         0.5 * (F_CUT_LOW + F_CUT_HIGH),
                         (F_CUT_HIGH - F_CUT_LOW),
                         ALLOWED_IN_BAND_RIPPLE_DB);
  ...
  private static DataSet2D generateDemoDataSet()
  {
    ...
    return new DefaultDataSet("dirac",
                              xValues,
                              yValues,
                              xValues.length,
                              true);
