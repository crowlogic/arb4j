...
/**
 * Example illustrating the Short-time Fourier Transform TODO: - add nonzero
 * imaginary part to sample data? - move computations out of javaFX application
 * thread
 * 
 * @author akrimm
 */
public class ShortTimeFourierTransformSample extends
                                             AbstractDemoApplication
{
  ...
  // rawData controls
  private final Spinner<Integer>      nSamples          = new Spinner<>(new SpinnerValueFactory.IntegerSpinnerValueFactory(1,
                                                                                                                           10_000,
                                                                                                                           4000,
                                                                                                                           500));
  private final Spinner<Double>       sampleRate        = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          1e6,
                                                                                                                          1e6,
                                                                                                                          1e5));
  private final Spinner<Double>       toneFreq          = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          1e6,
                                                                                                                          50e3,
                                                                                                                          1e3));
  private final Spinner<Double>       toneAmplitude     = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          10,
                                                                                                                          1.0,
                                                                                                                          0.5));
  private final Spinner<Double>       toneStart         = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          100,
                                                                                                                          0.1,
                                                                                                                          0.1));
  private final Spinner<Double>       toneStop          = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          100,
                                                                                                                          0.9,
                                                                                                                          0.1));

  // short time Fourier transform controls
  private final Spinner<Integer>      nFFT              = new Spinner<>(new SpinnerValueFactory.IntegerSpinnerValueFactory(1,
                                                                                                                           10_000,
                                                                                                                           128,
                                                                                                                           32));
  private final Spinner<Integer>      step              = new Spinner<>(new SpinnerValueFactory.IntegerSpinnerValueFactory(1,
                                                                                                                           10_000,
                                                                                                                           10,
                                                                                                                           10));
  ...
  // wavelet controls
  private final Spinner<Double>       nu                = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          200,
                                                                                                                          30,
                                                                                                                          10));
  private final Spinner<Double>       waveletFMin       = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          0.5,
                                                                                                                          0.0,
                                                                                                                          0.05));
  private final Spinner<Double>       waveletFMax       = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,
                                                                                                                          0.5,
                                                                                                                          0.5,
                                                                                                                          0.05));
  private final Spinner<Integer>      quantx            = new Spinner<>(new SpinnerValueFactory.IntegerSpinnerValueFactory(1,
                                                                                                                           10_000,
                                                                                                                           512,
                                                                                                                           32));
  private final Spinner<Integer>      quanty            = new Spinner<>(new SpinnerValueFactory.IntegerSpinnerValueFactory(1,
                                                                                                                           10_000,
                                                                                                                           128,
                                                                                                                           32));

  // DataSets
  private final MultiDimDoubleDataSet rawData           = new MultiDimDoubleDataSet("rawTimeData",
                                                                                    3);
  private final DoubleGridDataSet     stftData          = new DataSetBuilder("ShortTimeFourierTransform").setDimension(3)
                                                                                                         .setInitalCapacity(0)
                                                                                                         .build(DoubleGridDataSet.class);
  private final DoubleGridDataSet     waveletData       = new DataSetBuilder("WaveletTransform").setDimension(3)
                                                                                                .setInitalCapacity(0)
                                                                                                .build(DoubleGridDataSet.class);
  ...
  private Node rawDataSettingsPane()
  {
    ...
    installEventHandlers((evt) -> updateRawData(rawData),
                         nSamples.valueProperty(),
                         sampleRate.valueProperty(),
                         toneFreq.valueProperty(),
                         toneAmplitude.valueProperty(),
                         toneStart.valueProperty(),
  ...
  private void stft(final DataSet inputData, final DoubleGridDataSet outputData)
  {
    try
    {
      ...
      {
        newData = (DoubleGridDataSet) ShortTimeFourierTransform.complex(inputData,
                                                                        outputData,
                                                                        nFFT.getValue(),
                                                                        step.getValue(),
                                                                        apodizationWindow.getValue(),
                                                                        padding.getValue(),
                                                                        dbScale.isSelected(),
      ...
      {
        newData = (DoubleGridDataSet) ShortTimeFourierTransform.real(inputData,
                                                                     outputData,
                                                                     nFFT.getValue(),
                                                                     step.getValue(),
                                                                     apodizationWindow.getValue(),
  ...
  private Node stftSettingsPane()
  {
    ...
    installEventHandlers((evt) -> stft(rawData, stftData),
                         nFFT.valueProperty(),
                         step.valueProperty(),
                         apodizationWindow.valueProperty(),
                         padding.valueProperty(),
                         dbScale.selectedProperty(),
                         truncDCNyq.selectedProperty(),
                         complex.selectedProperty());
    return gridPane;
  }
  ...
  private void updateRawData(final MultiDimDoubleDataSet dataSetToUpdate)
  {
    ...
    for (int i = 0; i < yModel.length; i++)
    {
      ...
      yModel[i]  = (i > 0.2 * maxPoints && i < 0.9 * maxPoints) ? 0.7
                    * Math.sin(MathBase.TWO_PI * 30e3 * x * (2e3 * x + offset)) : 0;

      // single tone
      yModel[i] += (i > toneStart.getValue() * maxPoints
                    && i < toneStop.getValue() * maxPoints) ? toneAmplitude.getValue()
                                  * Math.sin(MathBase.TWO_PI * toneFreq.getValue() * x) : 0;

      // modulation around 0.4
      final double mod = Math.cos(MathBase.TWO_PI * 0.01e6 * x);
      yModel[i] += (i > 0.3 * maxPoints && i < 0.9 * maxPoints) ? Math.sin(MathBase.TWO_PI * (0.4 - 5e-4 * mod)
                    * 45e4 * x) : 0;
    ...
    dataSetToUpdate.set(new double[][]
    { tValues, yModel, imModel });
  ...
  private void wavelet(final DataSet inputData, final DoubleGridDataSet outputData)
  {
    try
    {
      ...
      final GridDataSet       newData = wtrafo.getScalogram(inputData.getValues(DataSet.DIM_Y),
                                                            quantx.getValue(),
                                                            quanty.getValue(),
                                                            nu.getValue(),
                                                            waveletFMin.getValue(),
                                                            waveletFMax.getValue());
      outputData.set(newData);
      outputData.getAxisDescription(DataSet.DIM_X)
                .set(inputData.getAxisDescription(DataSet.DIM_X).getName(),
                     inputData.getAxisDescription(DataSet.DIM_X).getUnit());
      outputData.getAxisDescription(DataSet.DIM_Y).set("frequency", "Hz");
      outputData.getAxisDescription(DataSet.DIM_Z)
                .set("Amplitude", inputData.getAxisDescription(DataSet.DIM_Y).getUnit());
  ...
  private Node waveletSettingsPane()
  {
    ...
    installEventHandlers((evt) -> wavelet(rawData, waveletData),
                         nu.valueProperty(),
                         waveletFMin.valueProperty(),
                         waveletFMax.valueProperty(),
                         quantx.valueProperty(),
                         quanty.valueProperty());
    return gridPane;
  }
