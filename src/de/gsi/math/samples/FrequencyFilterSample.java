 ...
 * @author rstein
 */
public class FrequencyFilterSample extends
                                   AbstractDemoApplication
{
  ...
  public Node getContent()
  {
    ...
    DefaultDataSet  dataSet = new DefaultDataSet("dirac",
                                                 xValues,
                                                 yValues,
                                                 xValues.length,
                                                 true);
    ...
    DefaultDataSet butterWorthA = new DefaultDataSet("Butterworth(4th)",
                                                     xValues,
                                                     FirFilter.filterSignal(yValues,
                                                                            null,
                                                                            fcut,
                                                                            4,
                                                                            FilterType.LOW_PASS,
    ...
    DefaultDataSet butterWorthB = new DefaultDataSet("Butterworth(6th)",
                                                     xValues,
                                                     FirFilter.filterSignal(yValues,
                                                                            null,
                                                                            fcut,
    ...
    DefaultDataSet butterWorthC = new DefaultDataSet("Butterworth(8th)",
                                                     xValues,
                                                     FirFilter.filterSignal(yValues,
                                                                            null,
                                                                            fcut,
    ...
    DefaultDataSet butterWorthA2 = new DefaultDataSet("Butterworth(4th)",
                                                      xValues,
                                                      FirFilter.filterSignal(yValues,
                                                                             null,
                                                                             fcut,
    ...
    DefaultDataSet butterWorthB2 = new DefaultDataSet("Butterworth(6th)",
                                                      xValues,
                                                      FirFilter.filterSignal(yValues,
                                                                             null,
                                                                             fcut,
    ...
    DefaultDataSet butterWorthC2 = new DefaultDataSet("Butterworth(8th)",
                                                      xValues,
                                                      FirFilter.filterSignal(yValues,
                                                                             null,
                                                                             fcut,
