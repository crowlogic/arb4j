 ...
 * @author rstein
 */
public class DataSetSpectrumSample extends
                                   AbstractDemoApplication
{
  ...
  public Node getContent()
  {
    ...
    DataSet dataSet2 = unequalSampling ? cosineFunction.getDataSetEstimate(-8.0,
                                                                           +8.0,
                                                                           N_SAMPLES) : cosineFunction.getDataSetEstimate(-10.0,
                                                                                                                          +10.0,
                                                                                                                          N_SAMPLES);
    ...
    DataSet magnitudeSpectrum = DataSetMath.magnitudeSpectrum(dataSet,
                                                              Apodization.Hann,
                                                              dbScale,
                                                              normaliseFrequency);
