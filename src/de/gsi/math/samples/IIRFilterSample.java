...
/**
 * Reads schottky measurement data and downmixes it with the following
 * algorithm: * apply band-pass arround the relevant band * multiply with 28 MHz
 * sine signal * low-pass filter * downsampling Then applies different IIR
 * Filters to the signal
 *
 * @author rstein
 */
public class IIRFilterSample extends
                             AbstractDemoApplication
{
  ...
  private final double        sampling         = 100e6;                                         // Sampling Rate: 100
                                                                                                // MS/s
  private final double        center           = 28e6;                                          // Center Frequency:
                                                                                                // 28 MHz
  private final double        width            = 0.5e6;                                         // Signal Bandwidth:
                                                                                                // 0.5 MHz
