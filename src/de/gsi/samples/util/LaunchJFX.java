...
/**
 * Helper class to launch JavaFX applications without manually adding modules
 * and exports to the java command line. Add a run configuration for this class
 * in the arguments tab and add as program argument:
 * <ul>
 * <li>for Eclipse IDE: "${java_type_name}"</li>
 * <li>for Intellij IDE: "$FileClass$"</li>
 * </ul>
 *
 * Then, any JavaFX Application Class can be run by selecting it in the Package
 * Explorer and running this run configuration. <br>
 * To be able to run JavaFX Applications outside of the chartfx project also add
 * a classpath entry of type "Advanced", "Variable", "${project_classpath}", but
 * there is no way to add the current projects dependencies to the classpath,
 * yet.
 * 
