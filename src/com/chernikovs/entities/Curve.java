                   ...
                   Entity
{
  ...
  public ArrayList<Vector> getFrenetFrame(float point)
  {
    ...
    Vector3f          position    = new Vector3f((float) function.calc(point)[0],
                                                 (float) function.calc(point)[1],
                                                 (float) function.calc(point)[2]);
    VectorFunction    tangent     = function.diff();
    Vector3f          tDirection  = new Vector3f((float) tangent.calc(point)[0],
                                                 (float) tangent.calc(point)[1],
                                                 (float) tangent.calc(point)[2]);
    Vector            t           = FunctionHandler.createVector(position,
                                                                 tDirection,
                                                                 new Vector3f(1,
                                                                              0,
                                                                              0),
    ...
    Vector3f          nDirection  = new Vector3f((float) normal.calc(point)[0],
                                                 (float) normal.calc(point)[1],
                                                 (float) normal.calc(point)[2]);
    Vector            n           = FunctionHandler.createVector(position,
                                                                 nDirection,
                                                                 new Vector3f(0,
                                                                              1,
                                                                              0),
    ...
    Vector3f          bDirection  = new Vector3f((float) binormal.calc(point)[0],
                                                 (float) binormal.calc(point)[1],
                                                 (float) binormal.calc(point)[2]);
    Vector            b           = FunctionHandler.createVector(position,
                                                                 bDirection,
                                                                 new Vector3f(0,
                                                                              0,
                                                                              1),
