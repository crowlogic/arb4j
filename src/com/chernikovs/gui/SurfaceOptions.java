...
/**
 * A class describing elements of graphical user interface that represent
 * surface options menu
 */
public class SurfaceOptions extends
                            Options
{
  ...
  public SurfaceOptions(Window window)
  {
    ...
    gridLabel.setPadding(new Insets(0,
                                    0,
                                    0,
                                    10));

    Label solidLabel = new Label("  Solid",
                                 solidMode);
    solidLabel.setContentDisplay(ContentDisplay.LEFT);
    solidLabel.setPadding(new Insets(0,
                                     0,
                                     0,
                                     10));
