...
public class BivariateFunction
{
  ...
  public BivariateFunction(ArrayDeque<String> postfix, String fstVar, String sndVar)
  {
    this.postfix = postfix;
    setVars(fstVar, sndVar);
  }

  public BivariateFunction(String infix, String fstVar, String sndVar)
  {
  ...
  public BivariateFunction(ArrayDeque<String> postfix)
  {
    this(postfix,
         "x",
         "y");
  ...
  public BivariateFunction(String infix)
  {
    this(infix,
         "x",
         "y");
  ...
  public Function calcByFst(double fst)
  {
    ...
    return new Function(newPostfix,
                        sndVar);
  }
   ...
   * 
   * @return new function which is a derivative of this function by the first
   *         argument
   */
   ...
   * 
   * @return new function which is a derivative of this function by the second
   *         argument
   */
  ...
  public double doubleIntegrate(double a1, double b1, double a2, double b2)
  {
    ...
    return new Function(resultEq,
                        sndVar).integrate(a2, b2);
  }
