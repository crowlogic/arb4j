...
public class VectorFunction
{
  ...
  public VectorFunction(List<ArrayDeque<String>> postfixes, String var)
  {
    ...
    {
      fns[i] = new Function(postfixes.get(i),
                            var);
    }
    this.var = var;
  }
  ...
  public VectorFunction diff()
  {
    ...
    return new VectorFunction(newFns,
                              var);
  }
  ...
  public VectorFunction normalize()
  {
    ...
    return new VectorFunction(list,
                              var);
  }
  ...
  public VectorFunction cross(VectorFunction f)
  {
    ...
    Function   x    = new Function(arg1.reduce().toPostfix(),
                                   var);
    Function   y    = new Function(arg2.reduce().toPostfix(),
                                   var);
    Function   z    = new Function(arg3.reduce().toPostfix(),
                                   var);

    return new VectorFunction(new Function[]
    { x, y, z },
                              var);
  }
  ...
  public Function dot(VectorFunction f)
  {
    ...
    return new Function(arg.reduce().toPostfix(),
                        var);
  }
