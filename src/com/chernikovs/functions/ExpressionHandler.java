...
public class ExpressionHandler
{
  ...
  /**
   * Operator attributes The first attribute is priority of the operator. Can be
   * from 0 to 2 inclusive The second attribute is associativity of the operator.
  ...
  /**
   * Function attributes The first attribute is number of parameters of the
   * function The second attribute is derivative of the function in infix form
   */
  private static final Map<String, List<String>>               fnAttribs = new HashMap<String, List<String>>()
                                                                         {
                                                                           {
                                                                             put("neg", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("-1");
                                                                             ...
                                                                             put("tand", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("(1+tand(x)^2)*pi/180)");
                                                                                                                                                      }
                                                                                                                                                    });
                                                                             put("cotd", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("(1+cotd(x)^2)*(-pi/180)");
                                                                                                                                                      }
                                                                                                                                                    });
                                                                             put("asind", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("180/pi/sqrt(1-x^2)");
                                                                                                                                                      }
                                                                                                                                                    });
                                                                             put("acosd", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("-180/pi/sqrt(1-x^2)");
                                                                             ...
                                                                             put("atand", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("180/pi/(1+x^2)");
                                                                             ...
                                                                             put("acotd", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("-180/pi/(1+x^2)");
                                                                             ...
                                                                             put("asec", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("1/(abs(x)*sqrt(x^2-1))");
                                                                                                                                                      }
                                                                                                                                                    });
                                                                             put("acsc", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("-1/(abs(x)*sqrt(x^2-1))");
                                                                             ...
                                                                             put("asinh", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("1/sqrt(1+x^2)");
                                                                             ...
                                                                             put("acosh", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("1/sqrt(x^2-1)");
                                                                             ...
                                                                             put("atanh", new ArrayList<String>()
                                                                                                                                                    {
                                                                                                                                                      {
                                                                                                                                                        add("1");
                                                                                                                                                        add("1/(1-x^2)");
   ...
   * @return new expressions with values instead of string representation of
   *         constants
   */
