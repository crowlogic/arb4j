...
import com.chernikovs.functions.ExpressionHandler;
...
import com.chernikovs.gui.Analysis;
import com.chernikovs.gui.CurveAnalysis;
import com.chernikovs.gui.CurveOptions;
    ...
    for (Integer i : getIndices())
    {
      ...
      if (getNeedsRedrawing(i))
      {
        ...
        else
        {
          ...
          { getFFrom(i) * k1, getFTo(i) * k1 }, getFStep(i) * k1, getColour(i), MasterRenderer.getLoader());
          if (getFrenet(i))
          {
