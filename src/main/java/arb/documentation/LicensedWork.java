 ...
 * {@link Document} known as a {@link License}
 */
public abstract class LicensedWork implements
                                   Work
{
  public Terms getDistributionTerms()
  {
    return new Terms("The Licensor(Stephen Crowley) hereby grants you the right to\n" + "•  copy,\n" + "•  modify,\n"
