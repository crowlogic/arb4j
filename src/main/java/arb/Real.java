...
public class Real implements Cloneable,Becomable<Real>,Domain<Real>,Serializable,Comparable<Real>,Iterable<Real>,NamedField<Real>,Lockable<Real>,IntFunction<Real>,Assignable<Real> {
  ...
  // Two-list pooling implementation. Lazily initialized: most Real instances
  // never borrow a variable, and eagerly constructing an ArrayDeque and a
  // HashSet per instance dominated allocation pressure (~36% of all allocation
  // in calibration profiles) for collections that were never touched.
  private Queue<Real> available;
  private Set<Real>   reserved;
