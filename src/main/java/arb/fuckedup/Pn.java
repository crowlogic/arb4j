  ...
  public ComplexPolynomial evaluate(Integer n, int order, int bits, ComplexPolynomial result)
  {
    ...
    if (order <= 1)
    {
      ...
      else
      {
        ...
        default -> this.vXℂ0020.identity()
                               .sub((Complex) this.αv.evaluate(n.sub(this.cℤ0001, bits, this.vℤ0011), order, bits, this.vℂ0002), bits, this.vXℂ0021)
                               .mul((ComplexPolynomial) this.Pn.evaluate(n.sub(this.cℤ0001, bits, this.vℤ0012), order, bits, this.vXℂ0022), bits, this.vXℂ0023)
                               .sub(((Complex) this.βv.evaluate(n.sub(this.cℤ0001, bits, this.vℤ0013),
                                                                order,
                                                                bits,
                                                                this.vℂ0003)).mul((ComplexPolynomial) this.Pn.evaluate(n.sub(this.cℤ0002, bits, this.vℤ0014),
                                                                                                                       order,
                                                                                                                       bits,
                                                                                                                       this.vXℂ0024),
                                                                                  bits,
