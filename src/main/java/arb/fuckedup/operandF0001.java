                          ...
                          Named
{
  ...
  private ComplexPolynomial evaluate_body(Integer j, int order, int bits, ComplexPolynomial result)
  {
    ...
    if (order <= 1)
    {
      ComplexPolynomial var9 = ((ComplexPolynomial) this.Q.evaluate(this.M, order, bits, this.vXℂ0026)).get(this.M.sub(j, bits, this.vℤ0015))
                                                                                                       .mul(this.vXℂ0027.identity().pow(j, bits, this.vXℂ0028),
                                                                                                            bits,
                                                                                                            result);
