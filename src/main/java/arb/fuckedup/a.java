            ...
            (switch (k.getSignedValue()) {
                  ...
                  default -> {
                     ...
                     while (var10003.compareTo(this.upperLimitℤ0001) <= 0) {
                        this.sumXℂ0001.add((ComplexPolynomial)this.aoperandF0001.evaluate(this.jXℂ0001ℤ0001, bits, this.valueXℂ0001), bits);
   ...
   public void invalidateCache(Set<Function<?, ?>> var1) {
      if (var1.add(this)) {
         ...
         if (this.aoperandF0001 != null) {
            this.aoperandF0001.invalidateCache(var1);
         }
      }
   }
