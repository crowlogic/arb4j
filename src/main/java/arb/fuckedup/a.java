    ...
    if (order <= 1)
    {
      ...
      else
      {
        ...
        default -> {
          ...
          if (this.a == this)
          {
            throw new AssertionError("self-alias: this.a == this — recursive call must target a separate instance per level (issue #1034)");
          }

          ComplexPolynomial var10001 = this.q.mul((ComplexPolynomial) this.a.evaluate(k.sub(this.cℤ0000, bits, this.vℤ0002), order, bits, this.vXℂ0007),
                                                  bits,
                                                  this.vXℂ0008);
  ...
  public void initialize()
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (this.operandF0001 == null)
        {
          Function var10002 = this.context.lookupFunctionInstance("operandF0001");
          if (var10002 != null)
          {
            this.operandF0001 = (operandF0001) var10002;
          }
          else
          {
