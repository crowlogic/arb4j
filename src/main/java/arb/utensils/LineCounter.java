...
public class LineCounter
{
  ...
  {
    String sourceDir = args.length > 0 ? args[0] : String.format("%s/git/arb4j/src", System.getProperty("user.home"));
  ...
  protected static long countLines(String sourceDir) throws IOException
  {
    ...
    {
      return sourceFiles.filter(LineCounter::shouldBeCounted).mapToLong(LineCounter::countLines).sum();
    }
  }
