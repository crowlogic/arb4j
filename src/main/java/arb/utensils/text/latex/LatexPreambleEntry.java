...
public record LatexPreambleEntry(String cmd, Map<String, String> options, boolean standalone)
{
   ...
   *         packages
   */
  private static final Consumer<LatexPreambleEntry> updateEntry(List<LatexPreambleEntry> entries,
                                                                LatexPreambleEntry additionalEntry)
  {
    return e ->
    {
      ...
      entries.set(entries.indexOf(e),
                  new LatexPreambleEntry(e.cmd(),
                                         Map.copyOf(m),
                                         e.standalone()));
    };
  }
