...
public final class KomaLetter
{
  ...
  /**
   * Whether to clean files with given file extensions. If no file extensions are
   * given, a default set of them will be removed.
   * 
  ...
  /**
   * Sets whether to show foldmarks, and which. See the corresponding chapter in
   * the KOMAScript manual. Default is {@code 'TBMPL'}.
   * <p>
  ...
  /**
   * Sets the city name and potentially the postal code of the recipient's
   * address.
   * 
  ...
  /**
   * Sets the date of the reference letter that the recipient of the current mail
   * sent previously.
   * 
  ...
  /**
   * Sets the date of the letter. Not necessary if the date of today should be
   * used.
   * 
  ...
  public int exec()
  {
    ...
    Latex tex = setup().folder(file.getParent().toString()).filename(file.getFileName().toString());
