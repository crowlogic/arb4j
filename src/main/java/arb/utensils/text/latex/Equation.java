...
public final class Equation implements Texable
{
  ...
  /**
   * Only relevant for {@link EquationEnvironment#ALIGNAT} and
   * {@link EquationEnvironment#ALIGNEDAT}. Needs to be set explicitly via
   * {@link Equation#equationColumns(int)}.
   */
   ...
   * 
   * @see <a href=
   *      "http://mirrors.ctan.org/macros/latex/required/amsmath/amsldoc.pdf">AMS
   *      User Guide</a>
   * @author Udo Hoefel
   */
  ...
  public Equation()
  {
    packages.add(new LatexPackage("amsmath",
                                  "breqn",
                                  Equation.class));
