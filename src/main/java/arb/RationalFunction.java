                              ...
                              AutoCloseableAssignable<RationalFunction>
{
  ...
  {
    return (complexVersion == null ? (complexVersion = new ComplexRationalFunction()) : complexVersion);
  }
  ...
  {
    return (complexFractionVersion == null ? (complexFractionVersion = new ComplexFractionRationalFunction()) : complexFractionVersion);
  }
  ...
  {
    assertPointerConsistency();
    try ( ComplexFraction numVal = new ComplexFraction(); ComplexFraction denVal = new ComplexFraction())
    {
