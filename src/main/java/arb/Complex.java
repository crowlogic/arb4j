...
/**
 ...
 public static Complex newVector(int dim)
 {
    ...
    return array;
     ...
     // Two-list pooling implementation. Lazily initialized: most Complex
  // instances never borrow a variable, and eagerly constructing an ArrayDeque
  // and a HashSet per instance dominated allocation pressure in calibration
  // profiles for collections that were never touched.
  private Queue<Complex> available;
  private Set<Complex>   allocated;
