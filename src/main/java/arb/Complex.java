                     ...
                     Assignable<Complex>
{
  ...
  {
    int N = size();
    assert randomMeasure.size() == N : String.format("randomMeasure.size=%d != N = %d", randomMeasure.size(), N);
  ...
  public ComplexRationalFunction mul(ComplexRationalFunction operand, int prec, ComplexRationalFunction result)
  {
  ...
  {
    return StreamSupport.stream(Spliterators.spliterator(iter, dim, Spliterator.SIZED | Spliterator.ORDERED), false);
  }
  ...
  public ComplexRationalFunction ascendingFactorial(Integer n, int bits, ComplexRationalFunction result)
  {
