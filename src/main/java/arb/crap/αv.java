...
public class αv implements ComplexSequence, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public ComplexSequence derivative() {
      return Function.express(Integer.class, Complex.class, ComplexSequence.class, "diffαv", "diff(α(n)(v),n)", this.context);
   }

   @Override
   public ComplexSequence integral() {
      return Function.express(Integer.class, Complex.class, ComplexSequence.class, "intαv", "int(α(n)(v),n)", this.context);
   }
   ...
   @Override
   public void close() {
      if (this.vXℂ0017 != this) {
         this.vXℂ0017.close();
      }

      if (this.α != null) {
         AutoCloseable var10001 = (AutoCloseable)this.α;
         this.α = null;
         var10001.close();
      }
   }
   ...
   public String typeset() {
      return "\\α\\left(n\\right)\\left(v\\right)";
   }
}
