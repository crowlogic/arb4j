...
public class ωfunc implements RealSequence, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public Real evaluate(Integer k, int order, int bits, Real result) {
      if (order > 1) {
         ...
         return this.cℤ0000
            ...
            .mul(this.j.add(this.β, bits, this.vℝ0055).add(this.cℤ0000, bits, this.vℝ0056).Γ(bits, this.vℝ0057), bits, this.vℝ0058)
            .mul(
               this.j
                  .add(k, bits, this.vℤ0006)
            ...
            .div(
               k.add(this.β, bits, this.vℝ0064)
                  .add(this.cℤ0000, bits, this.vℝ0065)
                  .Γ(bits, this.vℝ0066)
                  .mul(
                     this.j.add(this.α, bits, this.vℝ0067).add(this.β, bits, this.vℝ0068).add(this.cℤ0000, bits, this.vℝ0069).Γ(bits, this.vℝ0070),
                     bits,
                     this.vℝ0071
                  )
