...
public class ωfunc implements ComplexSequence, Typesettable, AutoCloseable, Initializable, Named {
         ...
         return this.cℤ0000
            ...
            .div(
               k.add(this.β, bits, this.vℝ0059)
                  ...
                  .mul(this.j.sub(k, bits, this.vℤ0008).add(this.cℤ0000, bits, this.vℤ0009).Γ(bits, this.vℝ0067), bits, this.vℝ0068)
                  .mul(k.add(this.cℤ0000, bits, this.vℤ0010).Γ(bits, this.vℝ0069), bits, this.vℝ0070),
               bits,
               result
            );
      }
   ...
   public ComplexSequence derivative() {
      return Function.express(
         ...
         "_diffωfunc",
         "diff(((((-1)^(j-k))*Γ((j+β)+1))*Γ((((j+k)+α)+β)+1))/(((Γ((k+β)+1)*Γ(((j+α)+β)+1))*Γ((j-k)+1))*Γ(k+1)),k)",
         this.context
      );
   }
   ...
   public ComplexSequence integral() {
      return Function.express(
         ...
         ComplexSequence.class,
         "_intωfunc",
         "int(((((-1)^(j-k))*Γ((j+β)+1))*Γ((((j+k)+α)+β)+1))/(((Γ((k+β)+1)*Γ(((j+α)+β)+1))*Γ((j-k)+1))*Γ(k+1)),k)",
         this.context
      );
   }
   ...
   public String toString() {
      return "ωfunc:k➔((((-1)^(j-k))*Γ((j+β)+1))*Γ((((j+k)+α)+β)+1))/(((Γ((k+β)+1)*Γ(((j+α)+β)+1))*Γ((j-k)+1))*Γ(k+1))";
   }

   @Override
   public String typeset() {
      return "\\frac{\\left(\\left({-(1)}^{(\\left(j-k\\right))} \\cdot \\Γ(\\left(\\left(j + β\\right) + 1\\right))\\right) \\cdot \\Γ(\\left(\\left(\\left(\\left(j + k\\right) + α\\right) + β\\right) + 1\\right))\\right)}{\\left(\\left(\\left(\\Γ(\\left(\\left(k + β\\right) + 1\\right)) \\cdot \\Γ(\\left(\\left(\\left(j + α\\right) + β\\right) + 1\\right))\\right) \\cdot \\Γ(\\left(\\left(j-k\\right) + 1\\right))\\right) \\cdot \\Γ(\\left(k + 1\\right))\\right)}";
   }
}
