                                 ...
                                 Sequence<Complex>
{
  ...
  static ComplexSequence express(String expression, Context context)
  {
    return (ComplexSequence) Sequence.express(null, Complex.class, expression, ComplexSequence.class, context);
  }
