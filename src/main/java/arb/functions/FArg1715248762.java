...
public class FArg1715248762 implements ComplexRationalNullaryFunction, Typesettable, AutoCloseable, Initializable, Named {
   public boolean isInitialized;
   public Context context = new Context();
   public final Integer cℤ0000 = new Integer("1");
   public final Integer cℤ0001 = new Integer("2");
   public Fraction vq0001 = new Fraction();
   ...
   public ComplexRationalFunction evaluate(Object in, int order, int bits, ComplexRationalFunction result) {
      if (order > 1) {
         ...
         return this.cℤ0000
            .div(this.cℤ0001, bits, this.vq0001)
            .mul(ComplexConstants.ⅈ, bits, this.vℂ0001)
            .div(this.vℚℂ0001.identity(), bits, this.vℚℂ0002)
            .neg(result);
      }
   }
