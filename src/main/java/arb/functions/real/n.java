               ...
               Initializable
{
  public static void main(String args[])
  {
    ...
    RationalFunction evaluate = n.evaluate(3, 128);
    System.out.println("L(3)=" + evaluate);
  ...
  public RationalFunction evaluate(Integer n, int order, int bits, RationalFunction result)
  {
    ...
    return v.ascendingFactorial(n, bits, ℝ1)
            ...
            .mul(hypqF1.init(vf1.set(FractionConstants.oneHalf.sub(n.div(cℤ1, bits, f1), bits, f2),
                                     n.div(cℤ1, bits, f3).neg(f4)),
                             vf2.set(f5.set(v), n.neg(f6), cℤ2.sub(v, bits, ℝ2).sub(n, bits, f7)),
