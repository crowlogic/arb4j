 ...
 *      {@link TheArb4jLibrary}
 */
public class ComplexHypergeometricQuasiPolynomial implements ComplexQuasiPolynomialNullaryFunction, Verifiable
{
  ...
  private ComplexQuasiPolynomialNullaryFunction                                            f;

  public Expression<Object, ComplexQuasiPolynomial, ComplexQuasiPolynomialNullaryFunction> F;
  ...
  public ComplexHypergeometricQuasiPolynomial(int p,
                                              int q,
                                              Expression<Object, ComplexQuasiPolynomial, ComplexQuasiPolynomialNullaryFunction> arg)
  {
  ...
  public ComplexHypergeometricQuasiPolynomial(Complex α,
                                              Complex β,
                                              Expression<Object, ComplexQuasiPolynomial, ComplexQuasiPolynomialNullaryFunction> arg)
  {
    this.α  = α;
    ...
    F = ComplexQuasiPolynomialNullaryFunction.parse("F", ComplexHypergeometricQuasiPolynomial.pFq, context)
                                             .substitute("z", arg);
  }
  ...
  @Override
  public ComplexQuasiPolynomial evaluate(Object nullary, int order, int bits, ComplexQuasiPolynomial res)
  {
    if (!initialized)
    {
      initialize();
