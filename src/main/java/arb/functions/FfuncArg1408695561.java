...
public class FfuncArg1408695561 implements Function<ComplexRationalFunction, ComplexRationalFunction>, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public Function derivative() {
      return Function.express(
         ComplexRationalFunction.class, ComplexRationalFunction.class, Function.class, "_diffFfuncArg1408695561", "diff(-((1/2)*ⅈ)/y,y)", this.context
      );
   }
