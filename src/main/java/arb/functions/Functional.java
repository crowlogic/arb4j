                           ...
                           Function<DOMAIN, FUNC>
{
  ...
  public static <D, C, F extends Function<? extends D, ? extends C>, G extends Functional<? extends D, ? extends C, ? extends F>>
         G
         express(Class<? extends D> domainClass, Class<? extends F> coDomainFunctionClass, Class<? extends G> functionalClass, String expression)
  {
  ...
  public static <D, C, F extends Function<? extends D, ? extends C>, G extends Functional<? extends D, ? extends C, ? extends F>>
         ...
         express(Class<? extends D> domainClass,
                 ...
                 Context context)
  {
    return Function.express(domainClass, coDomainFunctionClass, functionalClass, expression, context);
  }
