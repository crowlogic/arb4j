...
public class normSq implements RealSequence, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public Real evaluate(Integer i, int order, int bits, Real result) {
      if (order > 1) {
         ...
         Real var10000 = this.cℤ0000.pow(this.α.add(this.β, bits, this.vℝ0034).add(this.cℤ0001, bits, this.vℝ0035), bits, this.vℝ0036);
         ...
         arblib.arb_poly_set_coeff_arb(var22, 0, i.add(this.α, bits, this.vℝ0038).add(this.cℤ0001, bits, this.vℝ0039));
         Real var23;
         ...
         arblib.arb_poly_set_coeff_arb(var26, 0, i.add(this.β, bits, this.vℝ0042).add(this.cℤ0001, bits, this.vℝ0043));
         Real var27;
         ...
         arblib.arb_poly_set_coeff_arb(var34, 0, this.vℝ0038.add(this.β, bits, this.vℝ0052).add(this.cℤ0001, bits, this.vℝ0053));
         Real var35;
