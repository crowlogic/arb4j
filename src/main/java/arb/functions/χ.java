               ...
               Named
{
  ...
  public RealFunctionSequence derivative()
  {
    return Function.express(Integer.class,
                            ...
                            "_diffχ",
                            "diff(((((1/(p+1))*_intw(1))*(∫P(i)d1))-((((-1^(p+1))/(p+1))*_intw(-1))*(∫P(i)d-1)))/normSq(i),i)",
                            this.context);
  }
  ...
  public RealFunctionSequence integral()
  {
    return Function.express(Integer.class,
                            ...
                            RealFunctionSequence.class,
                            "_intχ",
                            "int(((((1/(p+1))*_intw(1))*(∫P(i)d1))-((((-1^(p+1))/(p+1))*_intw(-1))*(∫P(i)d-1)))/normSq(i),i)",
                            this.context);
  }
  ...
  {
    return "χ:i➔((((1/(p+1))*_intw(1))*(∫P(i)d1))-((((-1^(p+1))/(p+1))*_intw(-1))*(∫P(i)d-1)))/normSq(i)";
  }
