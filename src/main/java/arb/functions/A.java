...
{
  public Real c0 = new Real("1", 128);
  public Real c1 = new Real("2", 128);
  public Real G;
  public Integer x;
  ...
  public RealPolynomial evaluate(Integer in, int order, int bits, RealPolynomial result) {
    return ((RealPolynomial) this.F.evaluate((Integer) in, order, bits, (RealPolynomial) result))
        .mul((RealPolynomial) result, bits, this.l0).add(this.G, bits, this.l1)
        .mul(((RealPolynomial) this.C.evaluate((Integer) in, order, bits, this.l2)).sub(this.c0, bits, this.l3),
            bits, this.l4)
