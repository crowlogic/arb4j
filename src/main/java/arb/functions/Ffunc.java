...
public class Ffunc implements ComplexFunction, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public FfuncArg1408695561 FfuncArg1408695561;
   public FfuncArg1543043602 FfuncArg1543043602;
   public Integer m;
   ...
   public void initialize() {
      if (this.isInitialized) {
         ...
         if (this.FfuncArg1408695561 == null) {
            this.FfuncArg1408695561 = new FfuncArg1408695561();
         }

         if (this.FfuncArg1543043602 == null) {
            this.FfuncArg1543043602 = new FfuncArg1543043602();
         }
   ...
   public void close() {
      ...
      this.vℤ0001.close();
      this.vℤ0002.close();
      this.FfuncArg1543043602.close();
      this.FfuncArg1408695561.close();
   }
