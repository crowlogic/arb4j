...
public class FfuncArg1543043602 implements Function<ComplexRationalFunction, ComplexRationalFunction>, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public Function derivative() {
      return Function.express(
         ComplexRationalFunction.class, ComplexRationalFunction.class, Function.class, "_diffFfuncArg1543043602", "diff(((1/2)*ⅈ)/y,y)", this.context
      );
   }
