...
public class μ implements ComplexSequenceSequence, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public ComplexSequenceSequence derivative() {
      return Function.express(
         Integer.class, ComplexSequence.class, ComplexSequenceSequence.class, "_diffμ", "diff(Σk➔(ω(j)(k)*Γ(k+1)/Γ(k+1-γ)*χ(i)(k-γ)){k=⌈γ⌉…j},i)", this.context
      );
   }
   ...
   public ComplexSequenceSequence integral() {
      return Function.express(
         Integer.class, ComplexSequence.class, ComplexSequenceSequence.class, "_intμ", "int(Σk➔(ω(j)(k)*Γ(k+1)/Γ(k+1-γ)*χ(i)(k-γ)){k=⌈γ⌉…j},i)", this.context
      );
   }
