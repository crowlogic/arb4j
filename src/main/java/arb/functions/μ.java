...
public class μ implements RealSequenceSequence, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public RealSequenceSequence derivative() {
      return Function.express(
         Integer.class, RealSequence.class, RealSequenceSequence.class, "_diffμ", "diff(Σk➔(ω(j)(k)*Γ(k+1)/Γ(k+1-γ)*χ(i)(k-γ)){k=⌈γ⌉…j},i)", this.context
      );
   }
   ...
   public RealSequenceSequence integral() {
      return Function.express(
         Integer.class, RealSequence.class, RealSequenceSequence.class, "_intμ", "int(Σk➔(ω(j)(k)*Γ(k+1)/Γ(k+1-γ)*χ(i)(k-γ)){k=⌈γ⌉…j},i)", this.context
      );
   }
