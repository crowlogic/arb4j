...
public class operandF0001 implements Function<Integer, Real>, Typesettable, AutoCloseable, Initializable, Named {
   ...
   public Real evaluate(Integer k, int order, int bits, Real result) {
      if (order > 1) {
         ...
         Real var10000 = (Real)((RealSequence)this.ω.evaluate(this.j, order, bits, this.vSℝ0001)).evaluate(k, order, bits, this.vℝ0102);
         Real var36 = this.vℝ0103;
         ...
         arblib.arb_poly_set_coeff_arb(var38, 0, k.add(this.cℤ0000, bits, this.vℝ0104));
         Real var39;
         ...
         var10000 = var10000.mul(var36, bits, this.vℝ0105);
         Real var40 = this.vℝ0106;
         ...
         arblib.arb_poly_set_coeff_arb(var42, 0, k.add(this.cℤ0000, bits, this.vℤ0010).sub(this.γ, bits, this.vℝ0107));
         Real var43;
         ...
         return var10000.div(var40, bits, this.vℝ0108)
            .mul(
               (Real)((RealFunction)this.χ.evaluate(this.i, order, bits, this.vℝ0109)).evaluate(k.sub(this.γ, bits, this.vℝ0110), order, bits, this.vℝ0111),
               bits,
               result
            );
      }
   ...
   public Function derivative() {
      return Function.express(
         Integer.class, Real.class, Function.class, "_diffoperandF0001", "diff((((ω(j)(k))*Γ(k+1))/Γ((k+1)-γ))*(χ(i)(k-γ)),k)", this.context
      );
   }

   @Override
   public Function integral() {
      return Function.express(Integer.class, Real.class, Function.class, "_intoperandF0001", "int((((ω(j)(k))*Γ(k+1))/Γ((k+1)-γ))*(χ(i)(k-γ)),k)", this.context);
   }
