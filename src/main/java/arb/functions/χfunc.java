                   ...
                   Named
{
  ...
  public Real evaluate(Real p, int order, int bits, Real result)
  {
    ...
    else
    {
      ...
      return this.cℤ0000.div(p.add(this.cℤ0000, bits, this.vℝ0084), bits, this.vℝ0085)
                        .mul((Real) this._intw.evaluate(this.vℝ0086.set(this.cℤ0000),
                                                        order,
                                                        bits,
                                                        this.vℝ0087),
                             bits,
                        ...
                        .mul((Real) ((RealPolynomial) this.P.evaluate(this.i,
                                                                      ...
                                                                      this.vXℝ0015)).integral()
                                                                                    .evaluate(this.vℝ0089.set(this.cℤ0000),
                                                                                              order,
                                                                                              bits,
                                                                                              this.vℝ0090),
                             bits,
                        ...
                        .sub(this.cℤ0000.neg(this.vℤ0007)
                                        ...
                                        .mul((Real) this._intw.evaluate(this.cℤ0000.neg(this.vℝ0094),
                                                                        order,
                                                                        bits,
                                                                        this.vℝ0095),
                                             bits,
                                        ...
                                        .mul((Real) ((RealPolynomial) this.P.evaluate(this.i,
                                                                                      ...
                                                                                      this.vXℝ0016)).integral()
                                                                                                    .evaluate(this.vℝ0097.set(this.cℤ0000.neg(this.vℤ0008)),
                                                                                                              order,
                                                                                                              bits,
                                                                                                              this.vℝ0098),
                                             bits,
                             ...
                             bits,
                             this.vℝ0100)
                        .div((Real) this.normSq.evaluate(this.i, order, bits, this.vℝ0101),
                             bits,
                             result);
    }
  }
