...
/**
 * A fiber bundle is a structure (E, B, π, F), where E, B, and F are topological
 * spaces and π : E → B is a continuous surjection satisfying a local triviality
 * condition.
 *
 ...
 *
 * @param <E> total space (a TopologicalSpace)
 * @param <B> base space (a TopologicalSpace)
 * @param <F> fiber (a TopologicalSpace over each point of B)
