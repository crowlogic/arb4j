...
/**
 * TODO: need to distinguish between separable and nonseparable Hilbert spaces.
 * Any second order stochastic process with a separable linear space is an
 * {@link OscillatoryProcess}
 * 
 * A {@link HilbertSpace} is a special kind of {@link VectorSpace} equipped with
 * an inner product, which allows the definition of geometrical concepts such as
