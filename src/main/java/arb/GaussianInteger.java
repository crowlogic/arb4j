...
/**
 * A Gaussian integer is a {@link Complex} number whose real and imaginary parts are
 * both integers. The Gaussian integers, with ordinary addition and
 ...
 */
public class GaussianInteger implements Ring<GaussianInteger>
{
