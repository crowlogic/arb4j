                           ...
                           Becomable<ComplexMatrix>
{
  ...
  {
    assert getNumCols()
                  == that.getNumRows() : String.format("this matrix col count %d does not match right matrix row count %d", getNumCols(), that.getNumRows());
    assert getNumRows() == result.getNumRows() : String.format("Result matrix row count %d does not match left matrix row count %d",
                                                               result.getNumRows(),
                                                               getNumRows());
    assert that.getNumCols() == result.getNumCols() : String.format("Right matrix col count %d does not match result matrix col count %d",
                                                                    that.getNumCols(),
                                                                    result.getNumCols());
