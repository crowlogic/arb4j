...
public class Integrators
{
                                  ...
                                  Complex res)
  {
          ...
          Magnitude newTol = new Magnitude();)
    {
      ...
      allocation = 4;
      try ( Segment segment = new Segment(2 * allocation);)
      {
        segment.as.set(a);
        segment.bs.set(b);
        integrate(f,
                                  ...
                                  Complex res)
  {
          ...
          Magnitude newTol = new Magnitude();)
    {
      ...
      try ( Segment segment = new Segment(2 * allocation))
      {
        Complex   as = segment.as;
        Complex   bs = segment.bs;
        Complex   vs = segment.vs;
        Magnitude ms = segment.ms;
                        ...
                        boolean debug)
  {
    ...
    while (depth >= 1)
    {
      ...
      if (depth >= allocation - 1)
      {
        ...
        segment.resizeVectors(allocation);
      }
