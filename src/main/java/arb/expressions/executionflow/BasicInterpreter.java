 ...
 * @author Bing Ran
 */
public class BasicInterpreter extends
                              Interpreter<BasicValue> implements
                              Opcodes
{

  /**
   * Special type used for the {@literal null} literal. This is an object
   * reference type with descriptor 'Lnull;'.
   */
  public static final Type NULL_TYPE = Type.getObjectType("null");

  /**
   * Constructs a new {@link BasicInterpreter} for the latest ASM API version.
   * <i>Subclasses must not use this constructor</i>. Instead, they must use the
   * {@link #BasicInterpreter(int)} version.
   */
  ...
  public BasicValue newOperation(final AbstractInstructionNode insn)
  {
    ...
    case LDC:
      ...
      else if (value instanceof Type)
      {
        ...
        {
          throw new RuntimeException(insn + "Illegal LDC value " + value);
        }
      }
