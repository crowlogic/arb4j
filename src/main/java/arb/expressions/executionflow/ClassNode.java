                       ...
                       ClassVisitor
{
  ...
  /**
   * The class version. The minor version is stored in the 16 most significant
   * bits, and the major version in the 16 least significant bits.
   */
  public int                       version;

  /**
   * The class's access flags (see {@link org.objectweb.asm.Opcodes}). This field
   * also indicates if the class is deprecated {@link Opcodes#ACC_DEPRECATED} or a
   * record {@link Opcodes#ACC_RECORD}.
   */
  public int                       access;
   ...
   * {@link org.objectweb.asm.Type#getInternalName()}). For interfaces, the super
   * class is {@link Object}. May be {@literal null}, but only for the
   * {@link Object} class.
   */
  ...
  /**
   * The name of the method that contains the class, or {@literal null} if the
   * class has no enclosing class, or is not enclosed in a method or constructor
   * of its enclosing class (e.g. if it is enclosed in an instance initializer,
   * static initializer, instance variable initializer, or class variable
   * initializer).
   */
   ...
   * the class has no enclosing class, or is not enclosed in a method or
   * constructor of its enclosing class (e.g. if it is enclosed in an instance
   * initializer, static initializer, instance variable initializer, or class
   ...
   * {@link org.objectweb.asm.Type#getInternalName()}). May be {@literal null}.
   */
   ...
   * constructor</i>. Instead, they must use the {@link #ClassNode(int)} version.
   *
  ...
  {
    InnerClassNode innerClass = new InnerClassNode(name,
                                                   outerName,
                                                   innerName,
                                                   access);
  ...
  public RecordComponentVisitor
         visitRecordComponent(final String name, final String descriptor, final String signature)
  {
  ...
  public FieldVisitor visitField(final int access,
                                 ...
                                 final Object value)
  {
    FieldNode field = new FieldNode(access,
                                    name,
                                    descriptor,
                                    signature,
                                    value);
  ...
  {
    MethodNode method = new MethodNode(access,
                                       name,
                                       descriptor,
                                       signature,
                                       exceptions);
