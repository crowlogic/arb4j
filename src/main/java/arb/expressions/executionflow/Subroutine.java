...
public final class Subroutine
{
   ...
   * @param maxLocals the local variables that are read or written by this
   *                  subroutine.
  ...
  /**
   * Merges the given subroutine into this subroutine. The local variables read or
   * written by the given subroutine are marked as read or written by this one,
   * and the callers of the given subroutine are added as callers of this one (if
   * both have the same start).
   *
   * @param subroutine another subroutine. This subroutine is left unchanged by
   *                   this method.
