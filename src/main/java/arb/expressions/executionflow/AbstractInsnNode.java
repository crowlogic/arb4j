...
public abstract class AbstractInsnNode
{
   ...
   * used for real instructions (i.e. not for labels, frames, or line number
   * nodes). This list is a list of {@link TypeAnnotationNode} objects. May be
   * {@literal null}.
   */
   ...
   * only used for real instructions (i.e. not for labels, frames, or line number
   * nodes). This list is a list of {@link TypeAnnotationNode} objects. May be
   * {@literal null}.
   */
   ...
   *
   * @return the opcode of this instruction, or -1 if this is not a JVM
   *         instruction (e.g. a label or a line number).
   */
   ...
   *
   * @return the type of this instruction, i.e. one the constants defined in this
   *         class.
   */
  ...
  /**
   * Returns the next instruction in the list to which this instruction belongs,
   * if any.
   *
  ...
  protected final AbstractInsnNode cloneAnnotations(final AbstractInsnNode insnNode)
  {
    if (insnNode.visibleTypeAnnotations != null)
    {
      ...
      for (int i = 0, n = insnNode.visibleTypeAnnotations.size(); i < n; ++i)
      {
        ...
        TypeAnnotationNode cloneAnnotation  = new TypeAnnotationNode(sourceAnnotation.typeRef,
                                                                     sourceAnnotation.typePath,
