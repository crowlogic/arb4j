 ...
 */
public class FieldNode extends
                       FieldVisitor
{

  /**
   * The field's access flags (see {@link org.objectweb.asm.Opcodes}). This field
  ...
  /**
   * The field's initial value. This field, which may be {@literal null} if the
   ...
   *                   {@literal null} if the field does not have an initial
   *                   value, must be an {@link Integer}, a {@link Float}, a
   ...
   *                   {@link Long}, a {@link Double} or a {@link String}.
   */
  public FieldNode(final int api,
                   final int access,
                   final String name,
                   final String descriptor,
                   final String signature,
