 ...
 */
public class AnnotationNode extends
                            AnnotationVisitor
{
  ...
  /**
   * The name value pairs of this annotation. Each name value pair is stored as
   * two consecutive elements in the list. The name is a {@link String}, and the
   * value may be a {@link Byte}, {@link Boolean}, {@link Character},
   * {@link Short}, {@link Integer}, {@link Long}, {@link Float}, {@link Double},
   * {@link String} or {@link org.objectweb.asm.Type}, or a two elements String
   * array (for enumeration values), an {@link AnnotationNode}, or a {@link List}
   * of values of one of the preceding types. The list may be {@literal null} if
  ...
  public void visit(final String name, final Object value)
  {
    ...
    {
      values.add(Arrays.asList((byte[]) value));
    }
    else if (value instanceof boolean[])
    {
      values.add(Arrays.asList((boolean[]) value));
    }
    else if (value instanceof short[])
    {
      values.add(Arrays.asList((short[]) value));
    }
    else if (value instanceof char[])
    {
      values.add(Arrays.asList((char[]) value));
    }
    else if (value instanceof int[])
    {
      values.add(Arrays.asList((int[]) value));
    }
    else if (value instanceof long[])
    {
      values.add(Arrays.asList((long[]) value));
    }
    else if (value instanceof float[])
    {
      values.add(Arrays.asList((float[]) value));
    }
    else if (value instanceof double[])
    {
      values.add(Arrays.asList((double[]) value));
    }
    else
    {
      values.add(value);
   ...
   * version. This method checks that this node, and all its children recursively,
   * do not contain elements that were introduced in more recent versions of the
   * ASM API than the given version.
   *
