...
//                                                    
  ...
  Node<D, C, F> resolveFunctionDerivative(int startPos, VariableReference<D, C, F> reference)
  {
    ...
    VariableNode<D, C, F> variableNode = new VariableNode<D,C,F>(this,reference, this.position, false);
    // this should differentiate with respect to the argument variable of the function and then apply the argument
    // to the derivative of the function, rather than differentiating with respect to the independent or indeterminant 
    // variable of the expression it is contained within
    return function.differentiate(variableNode);
  }
