                                    ...
                                    Printer
{
  ...
  private static final String       USAGE             = "Prints a disassembled view of the given class.\n"
                + "Usage: StackTrackingTextifier [-nodebug] <fully qualified class name or class file name>";

  /**
   * The type of internal names (see {@link Type#getInternalName()}). See
   * {@link #appendDescriptor}.
   */
  ...
  private static final List<String> FRAME_TYPES       = Collections.unmodifiableList(Arrays.asList("T",
                                                                                                   "I",
                                                                                                   "F",
                                                                                                   "D",
                                                                                                   "J",
  ...
  /**
   * Constructs a new {@link StackTrackingTextifier}. <i>Subclasses must not use
   * this constructor</i>. Instead, they must use the
   * {@link #StackTrackingTextifier(int)} version.
   *
  ...
  public StackTrackingTextifier()
  {
    ...
    if (getClass() != StackTrackingTextifier.class)
    {
  ...
  /**
   * Constructs a new {@link StackTrackingTextifier}.
   *
   * @param api the ASM API version implemented by this visitor. Must be one of
   *            the {@code
   *     ASM}<i>x</i> values in {@link Opcodes}.
   */
  protected StackTrackingTextifier(final int api)
  {
    super(api);
  }
                    ...
                    final String[] interfaces)
  {
    ...
    stringBuilder.append("// class version ")
                 .append(majorVersion)
                 .append('.')
                 .append(minorVersion)
                 .append(" (")
  ...
  public Printer visitModule(final String name, final int access, final String version)
  {
    ...
    stringBuilder.append("module ")
                 ...
                 .append("\n\n");
    text.add(stringBuilder.toString());
    return addNewStackTrackingTextifier(null);
  }
  ...
  @Override
  public StackTrackingTextifier visitClassAnnotation(final String descriptor, final boolean visible)
  {
    text.add("\n");
  ...
  @Override
  public StackTrackingTextifier visitField(final int access,
                                           final String name,
                                           final String descriptor,
                                           final String signature,
                                           final Object value)
  ...
  @Override
  public StackTrackingTextifier visitMethod(final int access,
                                            final String name,
                                            final String descriptor,
                                            final String signature,
  ...
  private void
          visitExportOrOpen(final String method, final String packaze, final int access, final String... modules)
  {
    stringBuilder.setLength(0);
  ...
  @Override
  public StackTrackingTextifier visitAnnotation(final String name, final String descriptor)
  {
    visitAnnotationValue(name);
    stringBuilder.append('@');
    appendDescriptor(FIELD_DESCRIPTOR, descriptor);
    stringBuilder.append('(');
    text.add(stringBuilder.toString());
    return addNewStackTrackingTextifier(")");
  }

  @Override
  public StackTrackingTextifier visitArray(final String name)
  {
    visitAnnotationValue(name);
    stringBuilder.append('{');
    text.add(stringBuilder.toString());
  ...
  @Override
  public StackTrackingTextifier visitRecordComponentAnnotation(final String descriptor, final boolean visible)
  {
    return visitAnnotation(descriptor, visible);
  }

  @Override
  public Printer visitRecordComponentTypeAnnotation(final int typeRef,
                                                    final TypePath typePath,
                                                    final String descriptor,
                                                    final boolean visible)
  {
  ...
  @Override
  public StackTrackingTextifier visitFieldAnnotation(final String descriptor, final boolean visible)
  {
    return visitAnnotation(descriptor, visible);
  }
  ...
  @Override
  public StackTrackingTextifier visitAnnotationDefault()
  {
  ...
  @Override
  public StackTrackingTextifier visitMethodAnnotation(final String descriptor, final boolean visible)
  {
    return visitAnnotation(descriptor, visible);
  }
  ...
  @Override
  public StackTrackingTextifier visitAnnotableParameterCount(final int parameterCount, final boolean visible)
  {
    stringBuilder.setLength(0);
  ...
  @Override
  public StackTrackingTextifier
         visitParameterAnnotation(final int parameter, final String descriptor, final boolean visible)
  {
    stringBuilder.setLength(0);
    ...
    return addNewStackTrackingTextifier(stringBuilder.toString());
  }
  ...
  {
    stringBuilder.setLength(0);
    stringBuilder.append(tab2).append("IINC ").append(varIndex).append(' ').append(increment).append('\n');
    text.add(stringBuilder.toString());
  }
  ...
  // DontCheck(OverloadMethodsDeclarationOrder): overloads are semantically
  // different.
  public StackTrackingTextifier visitAnnotation(final String descriptor, final boolean visible)
  {
    stringBuilder.setLength(0);
    ...
    stringBuilder.append('(');
    text.add(stringBuilder.toString());
    return addNewStackTrackingTextifier(visible ? ")\n" : ") // invisible\n");
  }
   ...
   * @return a visitor to visit the annotation values.
   */
  public StackTrackingTextifier visitTypeAnnotation(final int typeRef,
                                                    final TypePath typePath,
                                                    final String descriptor,
                                                    final boolean visible)
  {
...
//
//    if (attribute instanceof StackTrackingTextifierSupport) {
//      if (labelNames == null) {
//        labelNames = new HashMap<>();
//      }
//      ((StackTrackingTextifierSupport) attribute).textify(stringBuilder, labelNames);
//    } else {
...
//    text.add(stringBuilder.toString());
  ...
  {
    stringBuilder.append("// access flags 0x").append(Integer.toHexString(accessFlags).toUpperCase()).append('\n');
  }
   ...
   * @param value an internal name (see {@link Type#getInternalName()}), type
   *              descriptor or a type signature. May be {@literal null}.
   */
  ...
  /**
   * Creates and adds to {@link #text} a new {@link StackTrackingTextifier},
   * followed by the given string.
   *
   * @param endText the text to add to {@link #text} after the
   *                StackTrackingTextifier. May be {@literal null}.
   * @return the newly created {@link StackTrackingTextifier}.
   */
  private StackTrackingTextifier addNewStackTrackingTextifier(final String endText)
  {
    StackTrackingTextifier StackTrackingTextifier = createStackTrackingTextifier();
    text.add(StackTrackingTextifier.getText());
    if (endText != null)
    {
      text.add(endText);
    }
    return StackTrackingTextifier;
  }

  /**
   * Creates a new {@link StackTrackingTextifier}.
   *
   * @return a new {@link StackTrackingTextifier}.
   */
  protected StackTrackingTextifier createStackTrackingTextifier()
  {
    return new StackTrackingTextifier(api);
  }
