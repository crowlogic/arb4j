                          ...
                          Node<D, R, F>
{
  ...
  protected void generateFactorClass(Class<?> resultType)
  {
    ...
    factorExpression = Compiler.express(factorFunctionFieldName,
                                        expr,
                                        expression.context,
                                        Integer.class,
                                        resultType,
  ...
  private Expression<Integer, R, Function<Integer, R>> factorExpression;
