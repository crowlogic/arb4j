 ...
 */
public class NewHypergeometricFunctionNode<D, R, F extends Function<? extends D, ? extends R>> extends
                                          FunctionNode<D, R, F>
{
  ...
  public NewHypergeometricFunctionNode(Expression<D, R, F> expression)
  {
    super("pFq",
          null,
          expression);
