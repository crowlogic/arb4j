...
/**
 * | Exception java.lang.UnsupportedOperationException: Derivative not implemented for
 * function: ϑ in expression 'diff(ϑ(t),t)'
 * 
                                               ...
                                               FunctionNode<D, C, F>
{
  ...
  protected PolySeriesFunctionDerivativeNode(String name, Expression<D, C, F> expr)
  {
    super(name,
          expr.resolve(),
          expr.require(')'));
