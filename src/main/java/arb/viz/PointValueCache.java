                             ...
                             AutoCloseable
{
                         ...
                         int numYpoints)
  {
    ...
    {
      path        = Path.of(id + ".arb");
      mappedFile0 = openOrCreateMemoryMappedFile(path, byteSize);
      path1       = Path.of(id + ".arb1");
      mappedFile1 = openOrCreateMemoryMappedFile(path1, byteSize);
                                 ...
                                 Closeable
  {
    ...
    {
      return "MappedFile[path=" + path + ", pointer=" + pointer + ", directBuffer=" + directBuffer + ", fileChannel="
                    + fileChannel + "]";
    }
  ...
  private MappedFile openOrCreateMemoryMappedFile(Path path, int bytes) throws IOException
  {
    MappedFile mf = new MappedFile();

    mf.path         = path;
    mf.fileChannel  = FileChannel.open(path,
