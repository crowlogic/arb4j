 ...
 */
public class SurfaceViewer extends
                           Application
{
  ...
  private final Rotate rotateX = new Rotate(20,
                                            Rotate.X_AXIS);
  private final Rotate rotateY = new Rotate(-45,
                                            Rotate.Y_AXIS);
  ...
  public void start(Stage primaryStage)
  {
    ...
    iv.setRotate(90);
    iv.setRotationAxis(new Point3D(1,
                                   0,
                                   0));
  ...
  public Image createImage(double size, float[][] noise)
  {
    ...
    WritableImage wr     = new WritableImage(width,
                                             height);
  ...
  private Group createCube(int size)
  {
    ...
    List<ThreeDimensionalAxis> cubeFaces = new ArrayList<>();
    ThreeDimensionalAxis       r;

    // back face
    r = new ThreeDimensionalAxis(size);
