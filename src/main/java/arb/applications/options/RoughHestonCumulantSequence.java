                                              ...
                                              RealSequence
{
   ...
   * and every strike. Φ = Σ_k T^{kμ+1}·d_k{k=0..N} depends ONLY on the model
   * parameters, T and N — none of which vary while a single price (or its
   ...
   * k=0..N O(M·J) times per price (the dominant cost in a calibration profile).
