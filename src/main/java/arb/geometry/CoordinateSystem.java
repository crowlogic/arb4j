 ...
 * geometric elements on a manifold such as Euclidean space.<br>
 * The order of the coordinates is significant, and they are sometimes
 * identified by their position in an ordered tuple and sometimes by a letter,
 * as in "the x-coordinate". <br>
 ...
 * into problems about numbers and vice versa; this is the basis of analytic
 * geometry.
 * 
 * @see <a href=
 *      "https://en.wikipedia.org/wiki/Coordinate_system">CoordinateSystem@Wikipedia</a>
 */
