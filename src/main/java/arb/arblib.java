...
public class arblib {
  ...
  public static void arith_number_of_partitions(long x, long n) {
    arblibJNI.arith_number_of_partitions(x, n);
  }
  ...
  public static void acb_acos(Complex numRows, Complex z, int prec) {
    arblibJNI.acb_acos(Complex.getCPtr(numRows), numRows, Complex.getCPtr(z), z, prec);
  }

  public static void acb_atan(Complex numRows, Complex z, int prec) {
    arblibJNI.acb_atan(Complex.getCPtr(numRows), numRows, Complex.getCPtr(z), z, prec);
  }

  public static void arb_poly_riemann_siegel_z_series(RealPolynomial res, RealPolynomial h, int n, int prec) {
    arblibJNI.arb_poly_riemann_siegel_z_series(RealPolynomial.getCPtr(res), res, RealPolynomial.getCPtr(h), h, n, prec);
  }

  public static void arb_poly_riemann_siegel_theta_series(RealPolynomial res, RealPolynomial h, int n, int prec) {
    arblibJNI.arb_poly_riemann_siegel_theta_series(RealPolynomial.getCPtr(res), res, RealPolynomial.getCPtr(h), h, n, prec);
  }
  ...
  public static void arb_hypgeom_beta_lower(Real res, Real a, Real b, Real z, int regularized, int prec) {
    arblibJNI.arb_hypgeom_beta_lower(Real.getCPtr(res), res, Real.getCPtr(a), a, Real.getCPtr(b), b, Real.getCPtr(z), z, regularized, prec);
  }
  ...
  public static void acb_poly_compose(ComplexPolynomial res, ComplexPolynomial poly1, ComplexPolynomial poly2, int prec) {
    arblibJNI.acb_poly_compose(ComplexPolynomial.getCPtr(res), res, ComplexPolynomial.getCPtr(poly1), poly1, ComplexPolynomial.getCPtr(poly2), poly2, prec);
  }

  public static void acb_poly_compose_series(ComplexPolynomial res, ComplexPolynomial poly1, ComplexPolynomial poly2, int n, int prec) {
    arblibJNI.acb_poly_compose_series(ComplexPolynomial.getCPtr(res), res, ComplexPolynomial.getCPtr(poly1), poly1, ComplexPolynomial.getCPtr(poly2), poly2, n, prec);
  }

  public static void arb_poly_compose(RealPolynomial res, RealPolynomial poly1, RealPolynomial poly2, int prec) {
    arblibJNI.arb_poly_compose(RealPolynomial.getCPtr(res), res, RealPolynomial.getCPtr(poly1), poly1, RealPolynomial.getCPtr(poly2), poly2, prec);
  }

  public static void arb_poly_compose_series(RealPolynomial res, RealPolynomial poly1, RealPolynomial poly2, int n, int prec) {
    arblibJNI.arb_poly_compose_series(RealPolynomial.getCPtr(res), res, RealPolynomial.getCPtr(poly1), poly1, RealPolynomial.getCPtr(poly2), poly2, n, prec);
  }
