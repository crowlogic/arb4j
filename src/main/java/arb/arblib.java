...
public class arblib
{
  ...
  {
    arblibJNI.arb_poly_mul(RealPolynomial.getCPtr(res),
                           res,
                           RealPolynomial.getCPtr(poly1),
                           poly1,
                           RealPolynomial.getCPtr(poly2),
                           poly2,
                           prec);
  }
  ...
  {
    arblibJNI.arb_poly_add(RealPolynomial.getCPtr(res),
                           res,
                           RealPolynomial.getCPtr(poly1),
                           poly1,
                           RealPolynomial.getCPtr(poly2),
  ...
  {
    arblibJNI.arb_poly_sub(RealPolynomial.getCPtr(res),
                           res,
                           RealPolynomial.getCPtr(poly1),
                           poly1,
                           RealPolynomial.getCPtr(poly2),
  ...
  {
    arblibJNI.arb_mat_scalar_mul_arb(RealMatrix.getCPtr(B),
                                     B,
  ...
  {
    arblibJNI.acb_dirichlet_lerch_phi(Complex.getCPtr(res),
                                      res,
                                      Complex.getCPtr(z),
                                      z,
                                      Complex.getCPtr(s),
  ...
  {
    arblibJNI.arb_poly_evaluate2(Real.getCPtr(y),
                                 y,
                                 Real.getCPtr(z),
                                 z,
                                 RealPolynomial.getCPtr(f),
                                 f,
                                 Real.getCPtr(x),
                                 x,
                                 prec);
  ...
  {
    arblibJNI.arb_mat_add(RealMatrix.getCPtr(res),
                          res,
  ...
  {
    arblibJNI.arb_mat_sub(RealMatrix.getCPtr(res),
                          res,
                          RealMatrix.getCPtr(mat1),
                          mat1,
                          RealMatrix.getCPtr(mat2),
  ...
  {
    arblibJNI.arb_mat_mul(RealMatrix.getCPtr(res),
                          res,
                          RealMatrix.getCPtr(mat1),
                          mat1,
                          RealMatrix.getCPtr(mat2),
  ...
  {
    arblibJNI.acb_hypgeom_legendre_p(Complex.getCPtr(res),
                                     res,
                                     Complex.getCPtr(n),
                                     n,
                                     Complex.getCPtr(m),
  ...
  {
    arblibJNI.acb_hypgeom_legendre_q(Complex.getCPtr(res),
                                     res,
                                     Complex.getCPtr(n),
                                     n,
                                     Complex.getCPtr(m),
  ...
  {
    arblibJNI.acb_hypgeom_spherical_y(Complex.getCPtr(res),
                                      res,
                                      n,
                                      m,
                                      Complex.getCPtr(theta),
                                      theta,
                                      Complex.getCPtr(phi),
                                      phi,
                                      prec);
  ...
  {
    arblibJNI.arb_hypgeom_legendre_p(Real.getCPtr(res),
                                     res,
                                     Real.getCPtr(n),
                                     n,
                                     Real.getCPtr(m),
  ...
  {
    arblibJNI.arb_hypgeom_legendre_q(Real.getCPtr(res),
                                     res,
                                     Real.getCPtr(n),
                                     n,
                                     Real.getCPtr(m),
  ...
  {
    arblibJNI.arb_hypgeom_legendre_p_ui_deriv_bound(Magnitude.getCPtr(dp),
                                                    dp,
                                                    Magnitude.getCPtr(dp2),
                                                    dp2,
                                                    n,
                                                    Real.getCPtr(x),
                                                    x,
  ...
  {
    arblibJNI.arb_hypgeom_legendre_p_ui_zero(Real.getCPtr(res),
                                             res,
                                             Real.getCPtr(res_prime),
                                             res_prime,
                                             n,
                                             Real.getCPtr(x),
                                             x,
  ...
  {
    arblibJNI.arb_hypgeom_legendre_p_ui_one(Real.getCPtr(res),
                                            res,
                                            Real.getCPtr(res_prime),
                                            res_prime,
                                            n,
  ...
  {
    arblibJNI.arb_hypgeom_legendre_p_ui_asymp(Real.getCPtr(res),
                                              res,
                                              Real.getCPtr(res_prime),
                                              res_prime,
                                              n,
  ...
  {
    arblibJNI.arb_hypgeom_legendre_p_ui(Real.getCPtr(res),
                                        res,
                                        Real.getCPtr(res_prime),
                                        res_prime,
                                        n,
  ...
  public static void acb_hypgeom_coulomb(Complex F,
                                         Complex G,
                                         Complex Hpos,
                                         Complex Hneg,
                                         Complex l,
                                         ...
                                         int prec)
  {
    arblibJNI.acb_hypgeom_coulomb(Complex.getCPtr(F),
                                  F,
                                  Complex.getCPtr(G),
                                  G,
                                  Complex.getCPtr(Hpos),
                                  Hpos,
                                  Complex.getCPtr(Hneg),
                                  Hneg,
                                  Complex.getCPtr(l),
                                  l,
                                  Complex.getCPtr(eta),
  ...
  {
    arblibJNI.acb_lambertw_bound_deriv(Magnitude.getCPtr(res),
                                       res,
                                       Complex.getCPtr(z),
                                       z,
                                       Complex.getCPtr(ez1),
  ...
  {
    arblibJNI._arb_vec_scalar_addmul(Real.getCPtr(res),
                                     res,
                                     Real.getCPtr(vec),
                                     vec,
                                     len,
  ...
  {
    arblibJNI.arb_mat_mul_entrywise(RealMatrix.getCPtr(res),
                                    res,
                                    RealMatrix.getCPtr(mat1),
                                    mat1,
                                    RealMatrix.getCPtr(mat2),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_j_0f1(Complex.getCPtr(res),
                                       res,
                                       Complex.getCPtr(nu),
                                       nu,
                                       Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_j_asymp(Complex.getCPtr(res),
                                         res,
                                         Complex.getCPtr(nu),
                                         nu,
                                         Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_i_0f1(Complex.getCPtr(res),
                                       res,
                                       Complex.getCPtr(nu),
                                       nu,
                                       Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_i_asymp(Complex.getCPtr(res),
                                         res,
                                         Complex.getCPtr(nu),
                                         nu,
                                         Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_i_scaled(Complex.getCPtr(res),
                                          res,
                                          Complex.getCPtr(nu),
                                          nu,
                                          Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_k_0f1(Complex.getCPtr(res),
                                       res,
                                       Complex.getCPtr(nu),
                                       nu,
                                       Complex.getCPtr(z),
  ...
  public static void acb_hypgeom_bessel_k_0f1_series(ComplexPolynomial res,
                                                     ...
                                                     int prec)
  {
    arblibJNI.acb_hypgeom_bessel_k_0f1_series(ComplexPolynomial.getCPtr(res),
                                              res,
  ...
  {
    arblibJNI.acb_hypgeom_bessel_k_asymp(Complex.getCPtr(res),
                                         res,
                                         Complex.getCPtr(nu),
                                         nu,
                                         Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_k_scaled(Complex.getCPtr(res),
                                          res,
                                          Complex.getCPtr(nu),
                                          nu,
                                          Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_bessel_jy(Complex.getCPtr(res1),
                                    res1,
  ...
  public static void acb_hypgeom_beta_lower_series(ComplexPolynomial res,
                                                   ...
                                                   int prec)
  {
    arblibJNI.acb_hypgeom_beta_lower_series(ComplexPolynomial.getCPtr(res),
                                            res,
                                            Complex.getCPtr(a),
                                            a,
                                            Complex.getCPtr(b),
  ...
  {
    arblibJNI.acb_hypgeom_beta_lower(Complex.getCPtr(res),
                                     res,
                                     Complex.getCPtr(a),
                                     a,
                                     Complex.getCPtr(b),
  ...
  {
    arblibJNI.acb_hypgeom_gamma_upper(Complex.getCPtr(res),
                                      res,
                                      Complex.getCPtr(s),
                                      s,
                                      Complex.getCPtr(z),
  ...
  {
    arblibJNI.acb_hypgeom_gamma_lower(Complex.getCPtr(res),
                                      res,
                                      Complex.getCPtr(s),
                                      s,
                                      Complex.getCPtr(z),
  ...
  public static void arb_dot_simple(Real res,
                                    ...
                                    int prec)
  {
    arblibJNI.arb_dot_simple(Real.getCPtr(res),
                             res,
  ...
  public static void arb_dot_precise(Real res,
                                     ...
                                     int prec)
  {
    arblibJNI.arb_dot_precise(Real.getCPtr(res),
                              res,
                              Real.getCPtr(initial),
                              initial,
                              subtract,
  ...
  {
    arblibJNI.arb_dot(Real.getCPtr(res),
                      res,
                      Real.getCPtr(initial),
                      initial,
                      subtract,
  ...
  {
    arblibJNI.arb_hypgeom_jacobi_p(Real.getCPtr(res),
                                   res,
                                   Real.getCPtr(n),
                                   n,
                                   Real.getCPtr(a),
  ...
  {
    arblibJNI.arb_hypgeom_gegenbauer_c(Real.getCPtr(res),
                                       res,
                                       Real.getCPtr(n),
                                       n,
                                       Real.getCPtr(m),
  ...
  {
    arblibJNI.arb_hypgeom_laguerre_l(Real.getCPtr(res),
                                     res,
                                     Real.getCPtr(n),
                                     n,
                                     Real.getCPtr(m),
  ...
  {
    arblibJNI.arb_hypgeom_legendre_p_ui_rec(Real.getCPtr(res),
                                            res,
                                            Real.getCPtr(res_prime),
                                            res_prime,
                                            n,
  ...
  {
    arblibJNI.acb_dft_rad2_precomp(Complex.getCPtr(w),
                                   w,
                                   Complex.getCPtr(v),
                                   v,
  ...
  {
    arblibJNI.arb_hypgeom_m(Real.getCPtr(res),
                            res,
                            Real.getCPtr(a),
                            a,
                            Real.getCPtr(b),
  ...
  public static void _acb_dirichlet_hardy_z_series(Complex res,
                                                   ...
                                                   int prec)
  {
    arblibJNI._acb_dirichlet_hardy_z_series(Complex.getCPtr(res),
                                            res,
                                            Complex.getCPtr(s),
                                            s,
                                            slen,
  ...
  public static void acb_dirichlet_hardy_z_series(ComplexPolynomial res,
                                                  ...
                                                  int prec)
  {
    arblibJNI.acb_dirichlet_hardy_z_series(ComplexPolynomial.getCPtr(res),
                                           res,
  ...
  {
    arblibJNI.acb_elliptic_f(Complex.getCPtr(res),
                             res,
                             Complex.getCPtr(phi),
                             phi,
                             Complex.getCPtr(m),
  ...
  {
    arblibJNI.acb_hypgeom_jacobi_p(Complex.getCPtr(res),
                                   res,
                                   Complex.getCPtr(n),
                                   n,
                                   Complex.getCPtr(a),
  ...
  {
    arblibJNI.acb_hypgeom_gegenbauer_c(Complex.getCPtr(res),
                                       res,
                                       Complex.getCPtr(n),
                                       n,
                                       Complex.getCPtr(m),
  ...
  {
    arblibJNI.acb_hypgeom_laguerre_l(Complex.getCPtr(res),
                                     res,
                                     Complex.getCPtr(n),
                                     n,
                                     Complex.getCPtr(m),
  ...
  {
    arblibJNI.arb_mat_solve_cho_precomp(RealMatrix.getCPtr(X),
                                        X,
  ...
  {
    return arblibJNI.arb_mat_spd_solve(RealMatrix.getCPtr(X),
                                       X,
                                       RealMatrix.getCPtr(A),
                                       A,
                                       RealMatrix.getCPtr(B),
  ...
  {
    arblibJNI.arb_mat_solve_ldl_precomp(RealMatrix.getCPtr(X),
                                        X,
                                        RealMatrix.getCPtr(L),
                                        L,
                                        RealMatrix.getCPtr(B),
  ...
  {
    return arblibJNI.acb_mat_eig_multiple(Complex.getCPtr(E),
                                          E,
  ...
  {
    arblibJNI.acb_dft_inverse_precomp(Complex.getCPtr(w),
                                      w,
                                      Complex.getCPtr(v),
                                      v,
  ...
  {
    arblibJNI.acb_poly_evaluate2(Complex.getCPtr(y),
                                 y,
                                 Complex.getCPtr(z),
                                 z,
  ...
  public static void acb_dot(Complex res,
                             ...
                             int prec)
  {
    arblibJNI.acb_dot(Complex.getCPtr(res),
                      res,
  ...
  {
    arblibJNI.acb_poly_interpolate_newton(ComplexPolynomial.getCPtr(poly),
                                          poly,
                                          Complex.getCPtr(xs),
                                          xs,
                                          Complex.getCPtr(ys),
  ...
  {
    arblibJNI.acb_dirichlet_hardy_z(Complex.getCPtr(res),
                                    res,
                                    Complex.getCPtr(t),
                                    t,
                                    DirichletGroup.getCPtr(G),
  ...
  public static void acb_dirichlet_hardy_theta(Complex res,
                                               ...
                                               int prec)
  {
    arblibJNI.acb_dirichlet_hardy_theta(Complex.getCPtr(res),
                                        res,
                                        Complex.getCPtr(t),
                                        t,
                                        DirichletGroup.getCPtr(G),
  ...
  public static void acb_modular_theta_series(ComplexPolynomial theta1,
                                              ...
                                              int prec)
  {
    arblibJNI.acb_modular_theta_series(ComplexPolynomial.getCPtr(theta1),
                                       theta1,
