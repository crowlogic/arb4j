...
public class arblib
{
  ...
  {
    arblibJNI.fmpz_poly_evaluate_complex_fmpq(Fraction.getCPtr(res_re),
                                              res_re,
                                              Fraction.getCPtr(res_im),
                                              res_im,
                                              IntegerPolynomial.getCPtr(poly),
                                              poly,
                                              Fraction.getCPtr(z_re),
                                              z_re,
                                              Fraction.getCPtr(z_im),
                                              z_im);
  }
  ...
  {
    arblibJNI.fmpz_poly_divrem(IntegerPolynomial.getCPtr(Q),
                               Q,
                               IntegerPolynomial.getCPtr(R),
                               R,
                               IntegerPolynomial.getCPtr(A),
                               A,
                               IntegerPolynomial.getCPtr(B),
                               B);
  }
  ...
  {
    return arblibJNI.acb_poly_divrem(ComplexPolynomial.getCPtr(Q),
                                     Q,
                                     ComplexPolynomial.getCPtr(R),
                                     R,
                                     ComplexPolynomial.getCPtr(A),
                                     A,
                                     ComplexPolynomial.getCPtr(B),
                                     B,
                                     prec);
  }
  ...
  {
    return arblibJNI.arb_poly_divrem(RealPolynomial.getCPtr(Q),
                                     Q,
                                     RealPolynomial.getCPtr(R),
                                     R,
                                     RealPolynomial.getCPtr(A),
                                     A,
                                     RealPolynomial.getCPtr(B),
                                     B,
                                     prec);
  }
