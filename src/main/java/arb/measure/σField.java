...
/**
 * A Borel algebra, σ-algebra, or σ-algebra, (also called a σ-field (of "random
 * events")) on a set X is a nonempty collection Σ of subset(subclass in java
 * terms) of X closed under taking complements, countable unions, and countable
