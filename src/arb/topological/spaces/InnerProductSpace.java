 ...
 * with an operation called an inner product. The inner product of two vectors
 ...
 * product spaces generalize Euclidean vector spaces, in which the inner product
 * is the dot product or scalar product of Cartesian coordinates. Inner product
 * spaces of infinite dimension are widely used in functional analysis. Inner
 * product spaces over the field of complex numbers are sometimes referred to as
 * unitary spaces. The first usage of the concept of a vector space with an
 * inner product is due to Giuseppe Peano, in 1898.[3]
 * 
