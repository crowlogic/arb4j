 ...
 * 
 * A {@link arb.spaces.TopologicalSpace} is a set endowed with a structure,
 * called a {@link arb.topological.Topology}, which allows defining continuous
 ...
 * {@link arb.geometry.curves.Circle}; connectedness, which allows
 * distinguishing a circle from two non-intersecting circles.
 */
