                  ...
                  EuclideanVectorSpace<Real>
{
  ...
  public void unlock()
  {
    int status = arbJNI.mprotect(swigCPtr,
                                 BYTES * dim,
   ...
   * @param prec
   */
  public void randomlyGenerate(ProbabilityDistributionFunction pdf, RandomVectorGenerator generator, int prec)
  {
    forEach(element -> pdf.sample(element, prec, generator));
  }
