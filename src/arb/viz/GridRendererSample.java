...
public class GridRendererSample extends
                                Application
{
  @Override
  public void start(final Stage primaryStage)
  {
    ...
    final XYChart xyChart1 = new XYChart(new DefaultNumericAxis("x-Axis 1",
                                                                0,
                                                                100,
                                                                10),
                                         new DefaultNumericAxis("y-Axis 1",
                                                                0,
                                                                100,
                                                                20));
    xyChart1.setPrefSize(600, 300);

    final XYChart xyChart2 = new XYChart(new DefaultNumericAxis("x-Axis 2",
                                                                0,
                                                                100,
                                                                10),
                                         new DefaultNumericAxis("y-Axis 2",
                                                                0,
                                                                100,
                                                                20));
    ...
    // xyChart2.getGridRenderer().getHorizontalMajorGrid().setStyle("-fx-stroke:
    // blue;-fx-stroke-width:4;");
    // xyChart2.getGridRenderer().getVerticalMajorGrid().setStyle("-fx-stroke:
    // darkblue");

    final XYChart xyChart3 = new XYChart(new DefaultNumericAxis("x-Axis 3",
                                                                0,
                                                                100,
                                                                10),
                                         new DefaultNumericAxis("y-Axis 3",
                                                                0,
                                                                100,
                                                                20));
    ...
    final XYChart xyChart4 = new XYChart(new DefaultNumericAxis("x-Axis 4",
                                                                0,
                                                                100,
                                                                10),
                                         new DefaultNumericAxis("y-Axis 4",
                                                                0,
                                                                100,
                                                                20));
    xyChart4.setPrefSize(600, 300);
    xyChart4.getGridRenderer().getHorizontalMajorGrid().getStrokeDashArray().setAll(15.0, 15.0);
    xyChart4.getGridRenderer().getVerticalMajorGrid().getStrokeDashArray().setAll(5.0, 5.0);
