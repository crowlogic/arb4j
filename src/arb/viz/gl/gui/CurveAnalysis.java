 ...
 * for curve analysis
 */
public class CurveAnalysis extends
                           AnalysisMenu
{
   ...
   */
  public CurveAnalysis(Window window, Display display)
  {
    this.window = window;
    ...
    slider.setPadding(new Insets(lineHeight / 6,
                                 0,
                                 0,
                                 0));
  ...
  public void bind(int index)
  {
    ...
    sliderValue.setOnTextChange(event ->
    {
      ...
      if (Math.abs(sliderVal - slider.getValue()) > Transformations.epsilon)
      {
