...
/**
 * A class describing elements of graphical user interface that represent menu
 * for surface analysis
 */
public class SurfaceAnalysis extends
                             AnalysisMenu
{
   ...
   */
  public SurfaceAnalysis(Window window, Display display )
  {
    assert display != null;
    this.window = window;
    ...
    sliderU.setPadding(new Insets(lineHeight / 6,
                                  0,
                                  0,
                                  0));
    ...
    sliderV.setPadding(new Insets(0,
                                  0,
                                  0,
                                  lineHeight / 6));
  ...
  private void pointChange(int index, float from1_, float from2_, float to1_, float to2_)
  {
    ...
    if (Math.abs(sliderUVal - sliderU.getValue()) > Transformations.epsilon)
    {
      sliderU.setValue(sliderUVal);
    }
    if (Math.abs(sliderVVal - sliderV.getValue()) > Transformations.epsilon)
    {
    ...
    case "Tangent plane":
      ...
      break;
    case "Osculating paraboloid":
      putu0v0Paraboloid(index,
                        new Vector2f(u,
                                     v));
      break;
    case "Main directions":
      putu0v0MainDir(index,
                     new Vector2f(u,
                                  v));
      break;
    }
