 ...
 * @author rstein
 */
public class ValueIndicatorSample extends
                                  Application
{
  ...
  public void start(final Stage primaryStage)
  {
    ...
    final XValueIndicator xValueIndicator = new XValueIndicator(xAxis,
                                                                20,
                                                                "x-indicator");
    chart.getStylesheets()
         .add(Objects.requireNonNull(getClass().getResource("ValueIndicatorSample.css")).toExternalForm());
