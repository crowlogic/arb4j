 ...
 * @author rstein
 */
public class LabelledMarkerSample extends
                                  Application
{
    ...
    for (int n = 0; n < LabelledMarkerSample.N_SAMPLES; n++)
    {
      ...
      if (n == 7)
      {
        dataSet.addDataStyle(n,
                             "strokeWidth=3;" + XYChartCss.FONT + "=\"Serif\";" + XYChartCss.FONT_SIZE + "=20;"
                                           + XYChartCss.FONT_POSTURE + "=italic;" + XYChartCss.FONT_WEIGHT
                                           + "=black;");
      }
      ...
      {
        dataSet.addDataStyle(n,
                             "strokeWidth=3;" + XYChartCss.FONT + "=\"monospace\";" + XYChartCss.FONT_POSTURE
                                           + "=italic;");
      }
    }
