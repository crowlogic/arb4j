 ...
 * @author rstein
 */
public class SimpleInvertedChartSample extends
                                       Application
{
  private static final Logger LOGGER    = LoggerFactory.getLogger(SimpleInvertedChartSample.class);
  private static final int    N_SAMPLES = 100;                                                     // default number
                                                                                                   // of data points
  ...
  public void start(final Stage primaryStage)
  {
    ...
    final var chart = new XYChart(xAxis,
                                  yAxis);
    ...
    final var scene = new Scene(new VBox(new HBox(new Label("X axis: "),
                                                  autoX,
                                                  invertAxisX,
                                                  new Label(" Y axis: "),
                                                  autoY,
