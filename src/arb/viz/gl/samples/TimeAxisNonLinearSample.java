...
public class TimeAxisNonLinearSample extends
                                     Application
{
  ...
  public void start(final Stage primaryStage)
  {
    ...
    final var xAxis1 = new NonLinearTimeAxis("time",
                                             "iso");
    xAxis1.setThreshold(0.6);
    xAxis1.setWeight(0.975);
    final var yAxis1 = new DefaultNumericAxis("y-axis",
                                              "a.u.");

    final var chart  = new XYChart(xAxis1,
                                   yAxis1);
    ...
    final var dataSet = new LimitedIndexedTreeDataSet("TestData",
                                                      100_000,
                                                      60);
    ...
    final var spThreshold = new Slider(0.0,
                                       1.0,
                                       xAxis1.getThreshold());
    ...
    final var xValueIndicator = new XValueIndicator(xAxis1,
                                                    xAxis1.getWidth() * xAxis1.getThreshold(),
                                                    "long-short");
    ...
    final var spWeight = new Slider(0.0,
                                    1.0,
                                    xAxis1.getWeight());
    ...
    root.setTop(new VBox(new HBox(new Label("threshold: "),
                                  spThreshold),
                         new HBox(new Label("weight: "),
                                  spWeight)));
    ...
    Runnable  updateFunction = () ->
                             {
                               ...
                               for (var i = 0; i < nSamples; i++)
                               {
                                 ...
                                 function.add(x,
                                              NonLinearTimeAxis.forwardTransform(x,
                                                                                 xAxis1.getThreshold(),
                                                                                 xAxis1.getWeight()));
                                 inverse.add(x,
                                             NonLinearTimeAxis.backwardTransform(x,
                                                                                 xAxis1.getThreshold(),
                                                                                 xAxis1.getWeight()));
                                 identity.add(x,
                                              NonLinearTimeAxis.backwardTransform(NonLinearTimeAxis.forwardTransform(x,
                                                                                                                     xAxis1.getThreshold(),
                                                                                                                     xAxis1.getWeight()),
                                                                                  xAxis1.getThreshold(),
                                                                                  xAxis1.getWeight()));
  ...
  public static class NonLinearTimeAxis extends
                                        DefaultNumericAxis
  { // NOPMD NOSONAR -- inheritance depth of 8 vs. desired 5 (unavoidable with
    // JavaFX)
    private final transient DoubleProperty       threshold   = new SimpleDoubleProperty(this,
                                                                                        "threshold",
                                                                                        0.6);       // 0.6
    private final transient DoubleProperty       weight      = new SimpleDoubleProperty(this,
                                                                                        "weight",
                                                                                        0.9);
    ...
    protected List<Double> calculateMajorTickValues(final double axisLength, final AxisRange axisRange)
    {
      ...
      {
        final var    axisPos = i / nTicksHalf1 * getThreshold() * axisLength;
      ...
      {
        final var    axisPos = (1.0 + i / nTicksHalf2) * getThreshold() * axisLength;
        final double value   = (getValueForDisplay(axisPos));
        tickValues.add(value);
        upper.add(value);
      }
