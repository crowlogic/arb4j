 ...
 * @author akrimm
 */
public class CustomFragmentedRendererSample extends
                                            Application
{
  ...
  public void start(final Stage primaryStage)
  {
    ...
    {
      @Override
      public List<DataSet> render(final GraphicsContext gc,
                                  final Chart renderChart,
                                  final int dataSetOffset,
    ...
    chart.getDatasets()
         .addAll(fragmentedDataSet,
                 new CosineFunction("Cosine",
                                    N_SAMPLES * N_DATA_SETS_MAX));
