...
public class ASTree implements
                    Cloneable
{

  /** A class describing operator of the syntax tree */
  private class Branch extends
                       Node implements
                       Cloneable
  {
    ...
    public Branch clone()
    {
      ...
      return new Branch(operation,
                        resChildren);
    }

    /**
     * Take derivative of the expression represented as tree which root is this
     * branch
     * 
     * @param var variable to differentiate by
     * @return root of the new tree that represents derivative of expression
     *         represented as the tree which root is this branch
     */
    @Override
                     ...
                     Cloneable
  {
     ...
     * @param var variable to differentiate by
     * @return root of the new tree that represents derivative of expression
     *         represented as the tree which root is this leaf
     */
    public Node diff(String var)
    {
      if (value.equals(var))
  ...
  private abstract class Node
  {
     ...
     * @param var variable to differentiate by
     * @return root of the new tree that represents derivative of expression
     *         represented as the tree which root is this node
     */
     ...
     * @return root of the new tree with the substituted tree instead of the
     *         variable
     */
     ...
     * @return root of the new tree with the substituted trees instead of the
     *         variables
     */
   ...
   */
  public void build(Deque<String> postfix)
  {
   ...
   * 
   * @param var variable to differentiate by
   * @return new tree that represents derivative of expression represented as this
   *         tree
   */
