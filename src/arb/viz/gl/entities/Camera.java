...
public class Camera
{
  ...
  private Vector3f position = new Vector3f(0,
                                           0,
                                           2);
  private Vector3f lookAt   = new Vector3f(0,
                                           0,
                                           0);
  ...
  private void calcLookAt()
  {
    if (Mouse.isButtonDown(GLFW_MOUSE_BUTTON_RIGHT))
    {
      ...
      Vector3f x  = new Vector3f((float) Math.cos(Math.toRadians(u)),
                                 0,
                                 (float) Math.sin(Math.toRadians(u)));
      Vector3f y  = new Vector3f((float) Math.sin(Math.toRadians(u)) * (float) Math.sin(Math.toRadians(v)),
