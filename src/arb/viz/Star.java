                  ...
                  Shape
{
  ...
  /**
   * <p>
   * Creates a new star whose center is located at the specified <code>x</code>
   * and <code>y</code> coordinates. The number of branches and their length can
   * be specified.
   * </p>
   *
   ...
   * @param outerRadius   the distance between the center of the star and the tip
   *                      of the branches
   ...
   */
  public Star(double x, double y, double innerRadius, double outerRadius, int branchesCount)
  {
    if (branchesCount < 3)
    {
  ...
  /**
   * <p>
   * Sets the inner radius of the star, that is the distance between its center
   * and the origin of the branches. The inner radius must always be lower than
   * the outer radius.
   * </p>
   *
   * @param innerRadius the distance between the center of the star and the origin
   *                    of the branches
  ...
  /**
   * <p>
   * Sets the outer radius of the star, that is the distance between its center
   * and the tips of the branches. The outer radius must always be greater than
   * the inner radius.
   * </p>
   *
   * @param outerRadius the distance between the center of the star and the tips
   *                    of the branches
   * @throws IllegalArgumentException if the inner radius is &gt;= outer radius
   */
   ...
   */
  public void setBranchCount(int branchesCount)
  {
    if (branchesCount <= 2)
    {
      throw new IllegalArgumentException("The number of branches must" + " be >= 3.");
