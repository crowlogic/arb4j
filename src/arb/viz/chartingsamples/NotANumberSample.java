...
/**
 * Test/demo that explicitly allows to draw NaN values in DataSets as well as
 * custom dash-based line-styling
 * <p>
 * Note: this works fine for &gt;JDK11/JFX11 but consistently crashes the
 * JDK8/JavaFX framework outside this library whenever e.g performing a zoom,
 * panning or other similar operation (ie. one of the reasons for the NaN
 * workaround in earlier chart-fx versions).
 * 
 * @author rstein
 */
public class NotANumberSample extends
                              Application
{
  private static final Logger LOGGER    = LoggerFactory.getLogger(NotANumberSample.class);
  private static final int    N_SAMPLES = 120;                                            // default number of data
                                                                                          // points
  ...
  public void start(final Stage primaryStage)
  {
    ...
    final XYChart chart = new XYChart(new DefaultNumericAxis("x-axis"),
                                      new DefaultNumericAxis("y-axis"));
    ...
    // performance for larger DataSets and/or high rate update (ie. 100
    // kPoints@25Hz)
