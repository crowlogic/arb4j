...
public class HexagonSamples extends
                            Application
{
  ...
  public void start(Stage primaryStage) throws Exception
  {
    ...
    final HexagonMap map         = new HexagonMap(6,
                                                  image,
                                                  80,
                                                  (q, r, imagePixelColor, map1) ->
                                                  {
                                                    if (imagePixelColor.getBlue() > 0.6)
                                                    {
                                                      final Hexagon h = new Hexagon(q,
                                                                                    r);
    ...
    final Scene hexScene = new Scene(new HBox(hexagonGroup,
                                              canvas),
                                     2 * 850,
                                     700);
