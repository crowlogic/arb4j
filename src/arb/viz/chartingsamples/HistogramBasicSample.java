...
public class HistogramBasicSample extends
                                  Application
{
  private Histogram dataSet1 = new Histogram("myHistogram1",
                                             4,
                                             0.0,
                                             4.0,
  ...
  public void start(final Stage primaryStage)
  {
    ...
    final Slider  nBinsSlider = new Slider(1,
                                           25,
                                           4);
    ...
    final Slider minSlider = new Slider(-10,
                                        10,
                                        0);
    minSlider.setShowTickLabels(true);
    minSlider.setShowTickMarks(true);
    final Slider maxSlider = new Slider(-10,
                                        10,
                                        4);
    ...
    {
      dataSet1 = new Histogram("myHistogram1",
                               (int) nBinsSlider.getValue(),
                               minSlider.getValue(),
                               maxSlider.getValue(),
                               histoBoundsCombo.getValue());
    ...
    {
      dataSet1 = new Histogram("Non equidistant histogram",
                               Arrays.stream(points.getText().split(","))
    ...
    addNeqDataSet.getItems()
                 .addAll( //
                         new Label("Bin boundaries: "),
                         points, //
    ...
    final Spinner<Double> valueToAddTo = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(Double.NEGATIVE_INFINITY,
    ...
    final Spinner<Integer> binToAddTo = new Spinner<>(0,
                                                      Integer.MAX_VALUE,
                                                      2);
    binToAddTo.setEditable(true);
    binToAddTo.disableProperty().bind(Bindings.not(addDataBinRadio.selectedProperty()));
    final Spinner<Double> valueToAdd = new Spinner<>(new SpinnerValueFactory.DoubleSpinnerValueFactory(Double.NEGATIVE_INFINITY,
                                                                                                       Double.POSITIVE_INFINITY,
                                                                                                       1.0,
                                                                                                       0.1));
