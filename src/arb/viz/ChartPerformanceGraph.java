 ...
 * @author rstein
 */
public class ChartPerformanceGraph extends
                                   Application
{
  ...
  private static DataSet loadData(final String fileName)
  {
    ...
    try ( BufferedReader csvReader = new BufferedReader(new InputStreamReader(Objects.requireNonNull(inputStream),
                                                                              StandardCharsets.UTF_8)))
    {
      ...
      while ((row = csvReader.readLine()) != null)
      {
        ...
        // JavaFx-Chart, ErrorDataSetRenderer, and ReducingLineRenderer each with
        // (n-samples,cpu) tuples
