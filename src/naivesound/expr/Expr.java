...
public interface Expr
{
  ...
  public class FuncContext<T> implements
                          Expr
  {
  ...
  class Builder
  {
    ...
    public Expr parse(String s, Map<String, Var> vars, Map<String, Func> funcs)
    {
      if (vars == null)
      {
        vars = new HashMap<>();
      ...
      for (String token : tokens)
      {
        ...
        else if (OPS.containsKey(token))
        {
          ...
          while (OPS.containsKey(o2) && ((Op.isLeftAssoc(op) && op.ordinal() > OPS.get(o2).ordinal()) || (op.ordinal() > OPS.get(o2).ordinal())))
          {
            Expr e = bind(o2, es);
            if (e == null)
            {
