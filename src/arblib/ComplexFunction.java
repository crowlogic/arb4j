...
public interface ComplexFunction
{
   ...
   * provided, the limit is set to a default value which currently equals
   * 
   * . This is the main parameter used to limit the amount of work before aborting
   * due to possible slow convergence or non-convergence. A lower limit allows
   * aborting faster. A higher limit may be needed for integrands with many
   * discontinuities or many singularities close to the integration path. This
   * limit is only taken as a rough guideline, and the actual number of function
   * evaluations may be slightly higher depending on the actual subdivisions.
   * 
   * slong depth_limit
   * 
