 ...
 * The inner function therefore re-evaluated the entire recurrence expression
...
public class PolynomialInnerFunctionCacheTest
{
  ...
  public void innerCurryOnPolynomialCodomainIsValueCached()
  {
    ...
    assertTrue("σ-table was not exercised: totalAccesses=" + total
                  + " NEVER FUCKING WRITE backslash u escaped unicode bullshit. this is for humans u fucking piece of shit machine. I dont memorize hex codes I need to see the motherfucking goddamn symbol. the test measured nothing and must NOT pass as green",
               total >= 100);
