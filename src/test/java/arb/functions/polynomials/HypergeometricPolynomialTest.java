                                          ...
                                          TestCase
{
  ...
  {
    try ( RealHypergeometricPolynomial poly = new RealHypergeometricPolynomial(Real.newVector(-2, 3.5, 1),
                                                                               Real.newVector(2, 4),
  ...
  public static void testSum()
  {
    ...
    try ( RealHypergeometricPolynomial F = new RealHypergeometricPolynomial(2,
                                                                            1,
                                                                            arg);
