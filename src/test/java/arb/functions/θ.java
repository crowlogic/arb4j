               ...
               Initializable
{
  ...
  public Real evaluate(Real t, int order, int bits, Real result)
  {
    return FractionConstants.oneQuarter.add(ComplexConstants.ⅈ.mul(t, bits, vℂ0001)
                                       ...
                                       .lnΓ(bits, vℂ0004)
                                       .im(bits, vℝ0001)
                                       .sub(t.mul(RealConstants.π.log(bits, vℝ0002), bits, vℝ0003)
                                             .div(cℤ0000, bits, vℝ0004),
                                            bits,
                                            result);
  }
  ...
  {
    return "t➔(im(lnΓ(¼+((ⅈ*t)/2))))-((t*(log(π)))/2)";
  }

  @Override
  public String typeset()
  {
    return "\\left(\\im(\\lnΓ(\\left(\\frac{1}{4} + \\frac{\\left(ⅈ \\cdot t\\right)}{2}\\right)))-\\frac{\\left(t \\cdot \\log(\\pi)\\right)}{2}\\right)";
  }
}