 ...
 * verifying that the three-level chain
 * int → {@link RealFunctional} → {@link RealFunction} → {@link Real}
 * composes and evaluates correctly end-to-end.
 */
                                             ...
                                             TestCase
{
  ...
  /**
   * Verifies that different indices produce independent chains that do not
   * share state:
   * <ul>
  ...
  public static void testIndependentChainsDoNotShareState()
  {
    ...
    Real t2 = new Real("2", BITS);
    Real t3 = new Real("3", BITS);
